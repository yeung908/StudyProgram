...
#if defined(WEBRTC_ANDROID)
CapturePlatform capturePlatform() const {
  return capture_platform_;
}
void set_capture_platform(CapturePlatform platform) {
  capture_platform_ = platform;
}
bool allow_use_uwst_optimize() const {
  return use_uwst_optimize_;
}
void set_allow_use_uwst_optimize(bool enabled) {
  use_uwst_optimize_ = enabled;
}
#endif
...
#if defined(WEBRTC_ANDROID)
  CapturePlatform capture_platform_;
  bool use_uwst_optimize_ = true;
#endif
};
