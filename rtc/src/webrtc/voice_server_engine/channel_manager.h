#ifndef WEBRTC_VOICE_SERVER_ENGINE_CHANNEL_MANAGER_H
#define WEBRTC_VOICE_SERVER_ENGINE_CHANNEL_MANAGER_H
...
namespace webrtc
{
    ...
    namespace vose
    {
        ...
        public:
            ...
            ChannelOwner CreateChannel(const VosEBase::ChannelConfig& config);
...
#endif //WEBRTC_VOICE_SERVER_ENGINE_CHANNEL_MANAGER_H