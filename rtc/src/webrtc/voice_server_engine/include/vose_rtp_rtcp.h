...
//  VoiceServerEngine* voe = VoiceServerEngine::Create();
...
//  base->Release();
//  rtp_rtcp->Release();
//  VoiceServerEngine::Delete(voe);
//
#ifndef WEBRTC_VOICE_SERVER_ENGINE_VOSE_RTP_RTCP_H
#define WEBRTC_VOICE_SERVER_ENGINE_VOSE_RTP_RTCP_H
...
namespace webrtc
{
    ...
    // VosERTPObserver
    class WEBRTC_DLLEXPORT VosERTPObserver
    {
    public:
    ...
    // VoERTP_RTCP
    class WEBRTC_DLLEXPORT VosERTP_RTCP
    {
    public:
        // Factory for the VoERTP_RTCP sub-API. Increases an internal
        // reference counter if successful. Returns NULL if the API is not
        // supported or if construction fails.
        static VosERTP_RTCP* GetInterface(VoiceServerEngine* VoiceServerEngine);

        // Releases the VoERTP_RTCP sub-API and decreases an internal
        // reference counter. Returns the new reference count. This value should
        // be zero for all sub-API:s before the VoiceServerEngine object can be safely
        // deleted.
    ...
    protected:
        VosERTP_RTCP() {}
        virtual ~VosERTP_RTCP() {}
    };

}  // namespace webrtc

#endif  // #ifndef WEBRTC_VOICE_SERVER_ENGINE_VOSE_RTP_RTCP_H
