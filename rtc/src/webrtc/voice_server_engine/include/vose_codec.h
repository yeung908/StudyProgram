#ifndef WEBRTC_VOICE_SERVER_ENGINE_VOSE_CODEC_H
#define WEBRTC_VOICE_SERVER_ENGINE_VOSE_CODEC_H
...
namespace webrtc
{
    ...
    {
    public:
        // Everything is same of VoECodec expect 'GetInterface' method.
        static VosECodec* GetInterface(VoiceServerEngine *engine);

        // Releases the VosECodec sub-API and decreases an internal
...
#endif //WEBRTC_VOICE_SERVER_ENGINE_VOSE_CODEC_H