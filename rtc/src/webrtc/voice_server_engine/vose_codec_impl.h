...
#ifndef WEBRTC_VOICE_SERVER_ENGINE_VOSE_CODEC_IMPL_H
#define WEBRTC_VOICE_SERVER_ENGINE_VOSE_CODEC_IMPL_H
...
namespace webrtc
{
    ...
    class VosECodecImpl : public VosECodec
    {
    public:
    ...
    protected:
        VosECodecImpl(vose::SharedData* shared);
        ~VosECodecImpl() override;
...
#endif  // WEBRTC_VOICE_SERVER_ENGINE_VOSE_CODEC_IMPL_H
