...
const WebRtcVoiceCodecs::CodecPref WebRtcVoiceCodecs::kCodecPrefs[14] = {
    ...
    {kOpusCodecName, 48000, 2, 120, true, {10, 20, 40, 60, 120},
     kOpusMaxBitrateBps},
#else
    {kOpusCodecName, 48000, 2, 120, true, {10, 20, 40, 60}, kOpusMaxBitrateBps},
#endif
    ...
    {kCnCodecName, 32000, 1, 99, false, {}},
    {kCnCodecName, 16000, 1, 98, false, {}},
    {kCnCodecName, 8000, 1, 13, false, {}},
    {kDtmfCodecName, 48000, 1, 116, false, {}},
    {kDtmfCodecName, 32000, 1, 115, false, {}},
    {kDtmfCodecName, 16000, 1, 114, false, {}},
    {kDtmfCodecName, 8000, 1, 106, false, {}}
};
