...
#include "webrtc/media/mediacodec/androidmediadecoder_jni.h"

#include "thirdparty/libyuv/include/libyuv/convert.h"
#include "thirdparty/libyuv/include/libyuv/convert_from.h"
#include "thirdparty/libyuv/include/libyuv/video_common.h"
#include "webrtc/media/mediacodec/androidmediacodeccommon.h"
...
using webrtc::SurfaceTextureHelper;
using webrtc::ScopedGlobalRef;
...
class MediaCodecVideoDecoder : public webrtc::VideoDecoder,
 ...
 private:
  ...
  std::unique_ptr<NativeRegistration> j_m_decoder_class_;
  std::unique_ptr<NativeRegistration> j_decoded_texture_buffer_class;
  std::unique_ptr<NativeRegistration> j_decoded_output_buffer_class;
  std::unique_ptr<GlobalRef> j_media_codec_video_decoder_;
...
{
  j_m_decoder_class_ = JVM::GetInstance()->environment()
            ->RegisterNatives("org/webrtc/MediaCodecVideoDecoder", NULL, 0);

  j_media_codec_video_decoder_ =
          j_m_decoder_class_->NewObject("<init>","()V");

  ScopedLocalRefFrame local_ref_frame(jni);
  codec_thread_->SetName("MediaCodecVideoDecoder", NULL);
  RTC_CHECK(codec_thread_->Start()) << "Failed to start MediaCodecVideoDecoder";

  j_init_decode_method_ = j_m_decoder_class_->
      GetMethodId("initDecode",
      "(Lorg/webrtc/MediaCodecVideoDecoder$VideoCodecType;"
      "IILorg/webrtc/SurfaceTextureHelper;)Z");
  j_reset_method_ = j_m_decoder_class_->GetMethodId("reset", "(II)V");
  j_release_method_ = j_m_decoder_class_->GetMethodId("release", "()V");
  j_dequeue_input_buffer_method_ = j_m_decoder_class_->GetMethodId("dequeueInputBuffer", "()I");
  j_queue_input_buffer_method_ = j_m_decoder_class_->GetMethodId("queueInputBuffer", "(IIJJJ)Z");
  j_dequeue_byte_buffer_method_ = j_m_decoder_class_->GetMethodId("dequeueOutputBuffer",
      "(I)Lorg/webrtc/MediaCodecVideoDecoder$DecodedOutputBuffer;");
  j_dequeue_texture_buffer_method_ = j_m_decoder_class_->GetMethodId("dequeueTextureBuffer",
      "(I)Lorg/webrtc/MediaCodecVideoDecoder$DecodedTextureBuffer;");
  j_return_decoded_byte_buffer_method_ =j_m_decoder_class_->GetMethodId("returnDecodedOutputBuffer", "(I)V");

  j_input_buffers_field_ = j_m_decoder_class_->GetFieldId("inputBuffers", "[Ljava/nio/ByteBuffer;");
  j_output_buffers_field_ = j_m_decoder_class_->GetFieldId("outputBuffers", "[Ljava/nio/ByteBuffer;");
  j_color_format_field_ = j_m_decoder_class_->GetFieldId("colorFormat", "I");
  j_width_field_ = j_m_decoder_class_->GetFieldId("width", "I");
  j_height_field_ = j_m_decoder_class_->GetFieldId("height", "I");
  j_stride_field_ = j_m_decoder_class_->GetFieldId("stride", "I");
  j_slice_height_field_ = j_m_decoder_class_->GetFieldId("sliceHeight", "I");

  j_decoded_texture_buffer_class = JVM::GetInstance()->environment()->RegisterNatives(
            "org/webrtc/MediaCodecVideoDecoder$DecodedTextureBuffer", nullptr, 0);
  j_texture_id_field_ = j_decoded_texture_buffer_class->GetFieldId("textureID", "I");
  j_transform_matrix_field_ = j_decoded_texture_buffer_class->GetFieldId("transformMatrix", "[F");
  j_texture_presentation_timestamp_ms_field_ = j_decoded_texture_buffer_class->GetFieldId("presentationTimeStampMs", "J");
  j_texture_timestamp_ms_field_ = j_decoded_texture_buffer_class->GetFieldId("timeStampMs", "J");
  j_texture_ntp_timestamp_ms_field_ = j_decoded_texture_buffer_class->GetFieldId("ntpTimeStampMs", "J");
  j_texture_decode_time_ms_field_ = j_decoded_texture_buffer_class->GetFieldId("decodeTimeMs", "J");
  j_texture_frame_delay_ms_field_ = j_decoded_texture_buffer_class->GetFieldId("frameDelayMs", "J");

  j_decoded_output_buffer_class = JVM::GetInstance()->environment()->RegisterNatives(
            "org/webrtc/MediaCodecVideoDecoder$DecodedOutputBuffer", NULL, 0);

  j_info_index_field_ = j_decoded_output_buffer_class->GetFieldId("index", "I");
  j_info_offset_field_ = j_decoded_output_buffer_class->GetFieldId("offset", "I");
  j_info_size_field_ = j_decoded_output_buffer_class->GetFieldId("size", "I");
  j_presentation_timestamp_ms_field_ = j_decoded_output_buffer_class->GetFieldId("presentationTimeStampMs", "J");
  j_timestamp_ms_field_ = j_decoded_output_buffer_class->GetFieldId("timeStampMs", "J");
  j_ntp_timestamp_ms_field_ = j_decoded_output_buffer_class->GetFieldId("ntpTimeStampMs", "J");
  j_byte_buffer_decode_time_ms_field_ = j_decoded_output_buffer_class->GetFieldId("decodeTimeMs", "J");
...
int32_t MediaCodecVideoDecoder::InitDecodeOnCodecThread() {
  ...
  if (use_surface_) {
    surface_texture_helper_ = SurfaceTextureHelper::create(
            JavaStringFromStdString(jni, "Decoder SurfaceTextureHelper"), render_egl_context_);
  ...
  bool success = jni->CallBooleanMethod(
      j_media_codec_video_decoder_->GetRawObject(),
  ...
  jobjectArray input_buffers = (jobjectArray)GetObjectField(
      jni, j_media_codec_video_decoder_->GetRawObject(), j_input_buffers_field_);
...
int32_t MediaCodecVideoDecoder::ReleaseOnCodecThread() {
  ...
  jni->CallVoidMethod(j_media_codec_video_decoder_->GetRawObject(), j_release_method_);
...
int32_t MediaCodecVideoDecoder::DecodeOnCodecThread(
  ...
  int j_input_buffer_index = jni->CallIntMethod(
      j_media_codec_video_decoder_->GetRawObject(), j_dequeue_input_buffer_method_);
...
void MediaCodecVideoDecoder::DettachThread() {
  return codec_thread_->Invoke<void>(
          RTC_FROM_HERE, Bind(&MediaCodecVideoDecoder::DettachOnCodecThread, this));
}

void MediaCodecVideoDecoder::DettachOnCodecThread()
{
  JVM::GetInstance()->jvm()->DetachCurrentThread();
}
...
bool MediaCodecVideoDecoder::DeliverPendingOutputs(
  ...
  jobject j_decoder_output_buffer =
      jni->CallObjectMethod(j_media_codec_video_decoder_->GetRawObject(),
  ...
  int color_format = GetIntField(jni, j_media_codec_video_decoder_->GetRawObject(),
      j_color_format_field_);
  int width = GetIntField(jni, j_media_codec_video_decoder_->GetRawObject(), j_width_field_);
  int height = GetIntField(jni, j_media_codec_video_decoder_->GetRawObject(), j_height_field_);
  int stride = GetIntField(jni, j_media_codec_video_decoder_->GetRawObject(), j_stride_field_);
  int slice_height = GetIntField(jni, j_media_codec_video_decoder_->GetRawObject(),
  ...
  if (use_surface_) {
    ...
    jobjectArray output_buffers = reinterpret_cast<jobjectArray>(GetObjectField(
        jni, j_media_codec_video_decoder_->GetRawObject(), j_output_buffers_field_));
...
MediaCodecVideoDecoderFactory::MediaCodecVideoDecoderFactory()
  ...
  JNIEnv* jni = GetCurrentThreadEnv();
  ScopedLocalRefFrame local_ref_frame(jni);
  std::unique_ptr<NativeRegistration> j_decoder_class = JVM::GetInstance()->environment()->
          RegisterNatives("org/webrtc/MediaCodecVideoDecoder", nullptr, 0);
  supported_codec_types_.clear();

  bool is_vp8_hw_supported = jni->CallStaticBooleanMethod(
          j_decoder_class->GetClass(),
          j_decoder_class->GetStaticMethodId("isVp8HwSupported", "()Z"));
  if (CheckException(jni)) {
  ...
  bool is_vp9_hw_supported = jni->CallStaticBooleanMethod(
          j_decoder_class->GetClass(),
          j_decoder_class->GetStaticMethodId("isVp9HwSupported", "()Z"));
  if (CheckException(jni)) {
  ...
  bool is_h264_hw_supported = jni->CallStaticBooleanMethod(
          j_decoder_class->GetClass(),
          j_decoder_class->GetStaticMethodId("isH264HwSupported", "()Z"));
  if (CheckException(jni)) {
...
webrtc::VideoDecoder* MediaCodecVideoDecoderFactory::CreateVideoDecoder(
  ...
  for (VideoCodecType codec_type : supported_codec_types_) {
    if (codec_type == type) {
      ...
      return new MediaCodecVideoDecoder(GetCurrentThreadEnv(), type,
                                        egl_context_);
    }
  }
