...
public class MediaCodecVideoDecoder {
  ...
  private static final String[] supportedVp8HwCodecPrefixes = {
      "OMX.qcom.", "OMX.Nvidia.", "OMX.Exynos.", "OMX.Intel.", "OMX.rk"};
  // List of supported HW VP9 decoders.
  private static final String[] supportedVp9HwCodecPrefixes = {"OMX.qcom.", "OMX.Exynos.", "OMX.rk"};
  // List of supported HW H.264 decoders.
  private static final String[] supportedH264HwCodecPrefixes = {
      "OMX.qcom.", "OMX.Intel.", "OMX.Exynos.", "OMX.rk"};
  // List of supported HW H.264 high profile decoders.
  private static final String[] supportedH264HighProfileHwCodecPrefixes = {"OMX.qcom.", "OMX.rk"};
