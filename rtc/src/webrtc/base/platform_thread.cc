...
#ifdef WEBRTC_ANDROID
  if (dettach_func_) (*dettach_func_)();
#endif
}
...
#ifdef WEBRTC_ANDROID
AttachThreadFunction PlatformThread::attach_func_ = NULL;
DettachThreadFunction PlatformThread::dettach_func_ = NULL;
void PlatformThread::SetAttachThreadFunctions(AttachThreadFunction attach,
                                              DettachThreadFunction dettach)
{
  attach_func_ = attach;
  dettach_func_ = dettach;
}
#endif
