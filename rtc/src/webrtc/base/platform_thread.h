...
typedef bool (*ThreadRunFunction)(void*);
    ...
    typedef void (*AttachThreadFunction)();
    typedef void (*DettachThreadFunction)();
#endif
...
#ifdef WEBRTC_ANDROID
    static void SetAttachThreadFunctions(AttachThreadFunction attach, DettachThreadFunction dettach);
#endif
...
#ifdef WEBRTC_ANDROID
    static AttachThreadFunction  attach_func_;
    static DettachThreadFunction dettach_func_;
#endif
