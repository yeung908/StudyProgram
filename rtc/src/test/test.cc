...
using webrtc::VoiceEngine;
using webrtc::VoEAudioProcessing;
using webrtc::VoEHardware;
...
//     VoEAudioProcessing *apm = VoEAudioProcessing::GetInterface(voe);
//     VoEHardware *adm = VoEHardware::GetInterface(voe);
//     VoENetwork *nw = VoENetwork::GetInterface(voe);
//     VosEBase *base = VosEBase::GetInterface(voe);
// 
//     base->Init();
// 
//     apm->EnableDriftCompensation(true);
//     apm->EnableHighPassFilter(true);
//     apm->SetAgcStatus(true);
//     apm->SetEcStatus(true);
//     apm->SetNsStatus(true);
// 
//     int sc = base->CreateChannel();
// 
//     while (1) {
//     }
// }
...
namespace webrtc
{
    namespace test
    {
        void RunHarness()
        {
            ...
            ASSERT_EQ(0, audio->SetAgcStatus(true));
            ASSERT_EQ(0, audio->SetEcStatus(true));
            ASSERT_EQ(0, audio->EnableHighPassFilter(true));
            ASSERT_EQ(0, audio->SetNsStatus(true));
