...
OPTION(OPUS_ARM_ASM "use of ARM asm optimization" ON)
OPTION(OPUS_ARM_INLINE_ASM " Use generic ARMv4 inline asm optimizations " ON)
IF(CMAKE_SYSTEM_PROCESSOR STREQUAL "armv5te")
	OPTION(OPUS_ARM_INLINE_EDSP "Use ARMv5E inline asm optimizations" ON)
	...
	OPTION(OPUS_ARM_MAY_HAVE_EDSP "Define if assembler supports EDSP instructions " ON)
	...
	OPTION(OPUS_ARM_PRESUME_EDSP "Define if binary requires EDSP instruction support" ON)
...
IF(CMAKE_SYSTEM_PROCESSOR STREQUAL "armv6")
	OPTION(OPUS_ARM_INLINE_EDSP "Use ARMv5E inline asm optimizations" ON)
	OPTION(OPUS_ARM_INLINE_MEDIA "Use ARMv6 inline asm optimizations" ON)
	OPTION(OPUS_ARM_INLINE_NEON "Use ARM NEON inline asm optimizations" OFF)
	OPTION(OPUS_ARM_MAY_HAVE_EDSP "Define if assembler supports EDSP instructions " ON)
	OPTION(OPUS_ARM_MAY_HAVE_MEDIA "Define if assembler supports ARMv6 media instructions" ON)
	OPTION(OPUS_ARM_MAY_HAVE_NEON "Define if compiler supports NEON instructions" OFF)
	OPTION(OPUS_ARM_MAY_HAVE_NEON_INTR "Compiler supports ARMv7/Aarch64 Neon Intrinsics" OFF)
	OPTION(OPUS_ARM_PRESUME_AARCH64_NEON_INTR "Define if binary requires Aarch64 Neon Intrinsics" OFF)
	OPTION(OPUS_ARM_PRESUME_EDSP "Define if binary requires EDSP instruction support" ON)
	OPTION(OPUS_ARM_PRESUME_MEDIA "Define if binary requires ARMv6 media instruction support" ON)
	OPTION(OPUS_ARM_PRESUME_NEON "Define if binary requires NEON instruction support" OFF)
	OPTION(OPUS_ARM_PRESUME_NEON_INTR "Define if binary requires NEON intrinsics support" OFF)
ENDIF()
...
IF(CMAKE_SYSTEM_PROCESSOR STREQUAL "armv7-a")
	OPTION(OPUS_ARM_INLINE_EDSP "Use ARMv5E inline asm optimizations" ON)
	OPTION(OPUS_ARM_INLINE_MEDIA "Use ARMv6 inline asm optimizations" ON)
	OPTION(OPUS_ARM_INLINE_NEON "Use ARM NEON inline asm optimizations" ON)
	OPTION(OPUS_ARM_MAY_HAVE_EDSP "Define if assembler supports EDSP instructions " ON)
	OPTION(OPUS_ARM_MAY_HAVE_MEDIA "Define if assembler supports ARMv6 media instructions" ON)
	OPTION(OPUS_ARM_MAY_HAVE_NEON "Define if compiler supports NEON instructions" ON)
	OPTION(OPUS_ARM_MAY_HAVE_NEON_INTR "Compiler supports ARMv7/Aarch64 Neon Intrinsics" ON)
	OPTION(OPUS_ARM_PRESUME_AARCH64_NEON_INTR "Define if binary requires Aarch64 Neon Intrinsics" OFF)
	OPTION(OPUS_ARM_PRESUME_EDSP "Define if binary requires EDSP instruction support" ON)
	OPTION(OPUS_ARM_PRESUME_MEDIA "Define if binary requires ARMv6 media instruction support" ON)
	OPTION(OPUS_ARM_PRESUME_NEON "Define if binary requires NEON instruction support" ON)
	OPTION(OPUS_ARM_PRESUME_NEON_INTR "Define if binary requires NEON intrinsics support" ON)
ENDIF()
...
IF(CMAKE_SYSTEM_PROCESSOR STREQUAL "aarch64")
	...
	OPTION(OPUS_ARM_MAY_HAVE_NEON "Define if compiler supports NEON instructions" ON)
	OPTION(OPUS_ARM_MAY_HAVE_NEON_INTR "Compiler supports ARMv7/Aarch64 Neon Intrinsics" ON)
	OPTION(OPUS_ARM_PRESUME_AARCH64_NEON_INTR "Define if binary requires Aarch64 Neon Intrinsics" ON)
	OPTION(OPUS_ARM_PRESUME_EDSP "Define if binary requires EDSP instruction support" ON)
	OPTION(OPUS_ARM_PRESUME_MEDIA "Define if binary requires ARMv6 media instruction support" ON)
	OPTION(OPUS_ARM_PRESUME_NEON "Define if binary requires NEON instruction support" ON)
	OPTION(OPUS_ARM_PRESUME_NEON_INTR "Define if binary requires NEON intrinsics support" ON)
...
OPTION(OPUS_HAVE_RTCD "Use run-time CPU capabilities detection" OFF)
OPTION(OPUS_X86_MAY_HAVE_AVX "Compiler supports X86 AVX Intrinsics" OFF)
OPTION(OPUS_X86_MAY_HAVE_SSE "Compiler supports X86 SSE Intrinsics" OFF)
OPTION(OPUS_X86_MAY_HAVE_SSE2 "Compiler supports X86 SSE2 Intrinsics" OFF)
OPTION(OPUS_X86_MAY_HAVE_SSE4_1 "Compiler supports X86 SSE4.1 Intrinsics" OFF)
OPTION(OPUS_X86_PRESUME_AVX "Define if binary requires AVX intrinsics support" OFF)
OPTION(OPUS_X86_PRESUME_SSE "Define if binary requires SSE intrinsics support" OFF)
OPTION(OPUS_X86_PRESUME_SSE2 "Define if binary requires SSE2 intrinsics support" OFF)
OPTION(OPUS_X86_PRESUME_SSE4_1 "Define if binary requires SSE4.1 intrinsics support" OFF)
