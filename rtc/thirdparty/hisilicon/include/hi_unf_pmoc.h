...
typedef enum hiUNF_PMOC_ACTUAL_WKUP_E
{
    ...
    HI_UNF_PMOC_WKUP_LSADC,       /**<Woken by the LSADC*/                    /**<CNcomment:被LowSpeedADC唤醒 */
    HI_UNF_PMOC_WKUP_CEC,         /**<Woken by the CEC*/                      /**<CNcomment:被CEC唤醒 */
    HI_UNF_PMOC_WKUP_UART,        /**<Woken by the UART*/                     /**<CNcomment:被UART唤醒 */
    HI_UNF_PMOC_WKUP_VGA,         /**<Woken by the VGA*/                      /**<CNcomment:被VGA唤醒 */
    HI_UNF_PMOC_WKUP_HDMI,        /**<Woken by the HDMI*/                     /**<CNcomment:被HDMI唤醒 */
...
typedef enum hiUNF_PMOC_SUSPEND_MODE_E
{
    HI_UNF_PMOC_SUSPEND_OFF= 0,     /**<Power off */                            /**<CNcomment:直接关机 */
    HI_UNF_PMOC_SUSPEND_MEM,        /**<Suspend to mem */                       /**<CNcomment:保存现场至内存 */
    HI_UNF_PMOC_SUSPEND_DISK,       /**<Suspend to disk */                      /**<CNcomment:保存现场至Flash */
    HI_UNF_PMOC_SUSPEND_BUTT
}HI_UNF_PMOC_SUSPEND_MODE_E;

typedef enum hiUNF_PMOC_BREATHLED_MODE_E
{
    HI_UNF_PMOC_BREATHLED_OFF= 0,     /**<Breathing light off */                      /**<CNcomment:待机关闭呼吸灯 */
    HI_UNF_PMOC_BREATHLED_ON,         /**<Breathing light on */                       /**<CNcomment:待机打开呼吸灯 */
    HI_UNF_PMOC_BREATHLED_SMART,      /**<Smart breathing light */                    /**<CNcomment:待机智能呼吸灯模式 */
    HI_UNF_PMOC_BREATHLED_BUTT
}HI_UNF_PMOC_BREATHLED_MODE_E;
...
typedef struct hiUNF_PMOC_SMARTLEDTIME_S
{
    HI_UNF_PMOC_TIME_S stLedOntime;         /**<Smart breathing light on time*/     /**<CNcomment:智能呼吸灯开启时间 */
    HI_UNF_PMOC_TIME_S stLedOfftime;        /**<Smart breathing light off time*/    /**<CNcomment:智能呼吸灯关闭时间 */
    HI_UNF_PMOC_TIME_S stLedCurrenttime;    /**<System current time */              /**<CNcomment:系统当前时间*/
}HI_UNF_PMOC_SMARTLEDTIME_S, *HI_UNF_PMOC_SMARTLEDTIME_S_PTR;
...
HI_S32 HI_UNF_PMOC_SetSuspendMode(HI_UNF_PMOC_SUSPEND_MODE_E eMode);

HI_S32 HI_UNF_PMOC_GetSuspendMode(HI_UNF_PMOC_SUSPEND_MODE_E *eMode);

HI_S32 HI_UNF_PMOC_GetWakeUpMode(HI_UNF_PMOC_ACTUAL_WKUP_E * pu32WakeUpStatus);

HI_S32 HI_UNF_PMOC_SetBreathLed(HI_U32 u32BreathLedCycle);
...
HI_S32 HI_UNF_PMOC_SetKeypadMask(HI_U32 kepadmask);


/**
\brief Switch to smart breathing light status.
CNcomment:\brief 设置智能呼吸灯的模式。CNend

\attention \n

\param[in] eBreathLedMode  Smart breathing light status .          CNcomment:智能呼吸灯的模式 CNend
\retval ::HI_ERR_PM        Set mode fail.                             CNcomment:设置模式失败CNend
\retval ::HI_SUCCESS          Set mode success.                           CNcomment:设置模式成功CNend
\see \n
N/A
*/
HI_S32 HI_UNF_PMOC_SetBreathLedMode(HI_UNF_PMOC_BREATHLED_MODE_E *eBreathLedMode);

/**
\brief Set ontime and off of smart breathing light and system current time.
CNcomment:\brief 设置智能呼吸灯开关以及系统当前时间。CNend

\attention \n

\param[in] pstSmartledTime  Ontime and off of smart breathing light and system current time .         CNcomment: 智能呼吸灯开关以及系统当前时间 CNend
\retval ::HI_ERR_PM        Set time fail.                           CNcomment:设置时间失败CNend
\retval ::HI_SUCCESS          Set time success.                           CNcomment:设置时间成功CNend
\see \n
N/A
*/
HI_S32 HI_UNF_PMOC_SetSmartLedTime(HI_UNF_PMOC_SMARTLEDTIME_S *pstSmartledTime);

/**
\brief Get the current temperature of chip.
CNcomment:\brief 获取当前芯片的温度。CNend

\attention \n

\param[in] ps32Temperature  the current temperature of chip .                         CNcomment: 当前芯片的温度 CNend
\retval ::HI_ERR_PMOC_FAILED_GETTEMPERATURE        Get temperature fail.              CNcomment:获取温度失败CNend
\retval ::HI_SUCCESS                               Get temperature success.           CNcomment:获取温度成功CNend
\see \n
N/A
*/
HI_S32 HI_UNF_PMOC_GetChipTemperature(HI_S32 *ps32Temperature);
