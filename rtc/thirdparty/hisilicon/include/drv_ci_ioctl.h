...
typedef struct hiCI_PCCD_READ_S
{
    HI_UNF_CI_PORT_E     enCIPort;
    HI_UNF_CI_PCCD_E     enCardId;
    HI_VIRT_ADDR_T   pu8Buffer;
    HI_VIRT_ADDR_T   pu32ReadLen;
} CI_PCCD_READ_S;
