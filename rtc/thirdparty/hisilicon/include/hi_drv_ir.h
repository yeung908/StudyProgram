...
#define MAX_CT1_INFR_NR (1)
#define MAX_CT2_INFR_NR (1)
...
#define NEC_FULL_PIONEER "nec full pioneer like"
#define CREDIT_CARD "credit"
#define SONY_D7C8 "sony d7c8"
#define SONY_D7C5 "sony d7c5"
#define TC9012 "tc9012"
#define TC9012_8BIT "tc9012 8bit"
#define RC6_MCE "MCE (Philips RC6-6A-32 subtype) protocol"
#define RC6_32BIT "Philips RC6-6A-32 protocol"
#define RC6_24BIT "Philips RC6-6A-24 protocol"
#define RC6_20BIT "Philips RC6-6A-20 protocol"
#define RC6_16BIT "Philips RC6-0-16 protocol"
...
#define HI_IR_SPACE_SIZE 0x1000

#define HI_IR_REG_REMAP(pvAddr, u32RegAddr)   \
    do {\
        pvAddr = ioremap_nocache(u32RegAddr, HI_IR_SPACE_SIZE);\
        if (NULL == pvAddr)\
        {\
            HI_ERR_IR("ioremap REG_ADDR[0x%x] failure!\n", u32RegAddr);\
            return HI_FAILURE;\
        }\
    } while (0)

#define HI_IR_REG_UNMAP(pvAddr)   iounmap(pvAddr)
