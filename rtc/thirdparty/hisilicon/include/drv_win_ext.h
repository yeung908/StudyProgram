...
typedef HI_S32 (* FN_WIN_SetSize)(HI_HANDLE hWin, HI_U32 u32Width,
        HI_U32 u32Height);
...
typedef HI_S32 (* FN_WIN_QueueFrame)(HI_HANDLE hWin, HI_DRV_WIN_FRAME_NODE_S *pstNode);
typedef HI_S32 (* FN_WIN_QueueUselessFrame)(HI_HANDLE hWin, HI_DRV_WIN_FRAME_NODE_S *pstNode);
typedef HI_S32 (* FN_WIN_DequeueFrame)(HI_HANDLE hWin, HI_DRV_VIDEO_FRAME_S *pFrameInfo);
typedef HI_S32 (* FN_WIN_QueueSyncFrame)(HI_HANDLE hWin, HI_DRV_VIDEO_FRAME_S *pstFrame, HI_U32 *pu32fence);

typedef HI_S32 (* FN_WIN_GetPlayInfo)(HI_HANDLE hWin, HI_DRV_WIN_PLAY_INFO_S *pstInfo);

typedef HI_S32 (* FN_WIN_SetZorder)(HI_HANDLE hWin, HI_LAYER_ZORDER_E enZFlag);
...
typedef HI_S32 (* FN_WIN_SetTiming)(HI_HANDLE hWin, HI_DRV_TIMING_INFO_S *pstTimingInfo);
typedef HI_S32 (* FN_WIN_SetNstdInfo)(HI_HANDLE hWin, HI_DRV_VIDEO_NONSTD_INFO_S *pstNstdInfo);

typedef HI_S32 (* FN_WIN_GetPreProcess)(HI_HANDLE hWin, HI_DRV_PRE_PROCESS_INFO_S *pstPreProcess);
typedef HI_S32 (* FN_WIN_SetPreDelay)(HI_HANDLE hWin, HI_U32 u32PreDelay);
...
typedef struct
{
    ...
    FN_WIN_QueueSyncFrame        pfnWinQueueSyncFrm       ; 
    ...
    FN_WIN_SetTiming             pfnWinSetTiming          ; 
    FN_WIN_SetNstdInfo           pfnWinSetNstdInfo        ;
    FN_WIN_GetPreProcess         pfnWinGetPreProcess      ; 
    FN_WIN_SetPreDelay           pfnWinSetPreDelay        ; 
