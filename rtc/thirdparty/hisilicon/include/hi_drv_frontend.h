...
#define HI_FATAL_TUNER(fmt...)   HI_FATAL_PRINT(HI_ID_TUNER, fmt)
#define HI_ERR_TUNER(fmt...)     HI_ERR_PRINT(HI_ID_TUNER, fmt)
#define HI_WARN_TUNER(fmt...)    HI_WARN_PRINT(HI_ID_TUNER, fmt)
#define HI_INFO_TUNER(fmt...)    HI_INFO_PRINT(HI_ID_TUNER, fmt)
#define HI_DEBUG_TUNER(fmt...)   HI_DBG_PRINT(HI_ID_TUNER, fmt)
