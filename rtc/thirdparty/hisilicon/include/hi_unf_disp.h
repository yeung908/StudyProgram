...
/**Panel interface ID */
/**CNcomment:Panel 接口ID  */
typedef enum hiUNF_DISP_PANEL_E
{
    HI_UNF_DISP_PANEL_0,            /**<PANEL interface 0 *//**<CNcomment:PANEL接口0 */
    HI_UNF_DISP_PANEL_BUTT,
}HI_UNF_DISP_PANEL_E;
...
typedef enum  hiUNF_DISP_INTF_TYPE_E
{
    ...
    HI_UNF_DISP_INTF_TYPE_PANEL,    /**<SVIDEO interface type*//**<CNcomment:SVIDEO接口类型*/
    HI_UNF_DISP_INTF_TYPE_AVOUT,    /**<SVIDEO interface type*//**<CNcomment:SVIDEO接口类型*/
...
/**define the Avout Source type enum*/
/**CNcomment:定义Avout信号源类型枚举*/
typedef enum hiUNF_AVOUT_SOURCE_E
{
    HI_UNF_AVOUT_SOURC_ATV_INT, /**<ATV Internal demo input*//**<CNcomment:ATV 内置demo输入*/
    HI_UNF_AVOUT_SOURC_ATV_EXT, /**<ATV External demo input*//**<CNcomment:ATV 内置demo输入*/
    HI_UNF_AVOUT_SOURC_DTV,     /**<DTV input*//**<CNcomment:DTV输入*/
    HI_UNF_AVOUT_SOURC_CVBS,    /**<CVBS input *//**<CNcomment:CVBS输入*/
    HI_UNF_AVOUT_SOURC_YPBPR,   /**<YPBPR input *//**<CNcomment:YPBPR输入*/
    HI_UNF_AVOUT_SOURC_VGA,     /**<VGA input *//**<CNcomment:VGA输入*/
    HI_UNF_AVOUT_SOURC_HDMI,    /**<CVBS HDMI *//**<CNcomment:HDMI输入*/
    
    HI_UNF_AVOUT_SOURC_BUTT,
}HI_UNF_AVOUT_SOURCE_E;

/**define the AVOUT type struct of interface*/
/**CNcomment:定义AVOUT接口结构*/
typedef struct  hiUNF_DISP_INTF_AVOUT_S
{
    HI_U8 u8Dac;                        /**<DAC num of AVOUT  *//**<CNcomment:AVOUT端子dac端口号*/
    HI_UNF_AVOUT_SOURCE_E enAvoutSrc;   /**<DAC num of AVOUT  *//**<CNcomment:AVOUT端子dac端口号*/
}HI_UNF_DISP_INTF_AVOUT_S;
...
typedef struct  hiUNF_DISP_INTF_S
{
    ...
    union
    {
        HI_UNF_DISP_PANEL_E     enPanel;       /**<PANEL id *//**<CNcomment:BT1120序号*/
        ...
        HI_UNF_DISP_INTF_AVOUT_S    stAvout;    /**<intf config of AVOUT  *//**<CNcomment:AVOUT接口配置*/
    }unIntf;
}HI_UNF_DISP_INTF_S;
...
/**Defines snapshot attribution struct.*/
/**CNcomment: 定义截屏属性结构*/
typedef struct hiUNF_DISP_SNAP_ATTR_S
{
	HI_U32 u32Width; 								 /**<user define width of snapshot*//**<CNcomment: 用户定义截屏宽度*/
	HI_U32 u32Height;  								 /**<user define height of snapshot*//**<CNcomment: 用户定义截屏高度*/                      
}HI_UNF_DISP_SNAP_ATTR_S;
...
typedef enum hiUNF_DISP_3D_E
{
    ...
    HI_UNF_DISP_3D_LINE_ALTERNATIVE,                /**<3d type:Line alternative Left Eye Fisrt*//**<CNcomment:3d 模式:行交错,左眼优先*/
    ...
    HI_UNF_DISP_3D_LINE_ALTERNATIVE_RL,             /**<3d type:Line alternative Right Eye Fisrt*//**<CNcomment:3d 模式:行交错,右眼优先*/
    HI_UNF_DISP_3D_BUTT
}HI_UNF_DISP_3D_E;
...
/**define 3D to 2D Eye select enum */
/**CNcomment:定义3D转2D画面内容选择枚举 */
typedef enum hiUNF_DISP_3DT2D
{
    HI_UNF_DISP_3DT2D_L = 0,     /**<Left eye Select *//**<CNcomment:选择左眼输出*/
    HI_UNF_DISP_3DT2D_R,         /**<Right eye Select *//**<CNcomment:选择右眼输出*/
    
    HI_UNF_DISP_3DT2D_BUTT,       
} HI_UNF_DISP_3DT2D_E;

/**define video 3d mode enum */
/**CNcomment:定义3D视频播放模式枚举 */
typedef enum hiUNF_DISP_3DMode
{
    HI_UNF_DISP_3DMODE_2D = 0,  /**<2D mode *//**<CNcomment:2D模式播放 */
    HI_UNF_DISP_3DMODE_2DTO3D,  /**<2D to 3D mode *//**<CNcomment:2D转3D模式播放 */
    HI_UNF_DISP_3DMODE_3D,      /**<3D mode *//**<CNcomment:3D模式播放 */
    
    HI_UNF_DISP_3DMODE_BUTT,       
} HI_UNF_DISP_3DMODE_E;


/* define DISP Current Display information structure*/
/* CNcomment:定义DISP当前显示信息数据结构 */
typedef struct hiUNF_DISP_DISPLAYINFO_S
{
    HI_BOOL bMemcEnable;    /**<memc enable status *//**<CNcomment:memc使能状态 */ 
    
}HI_UNF_DISP_DISPLAYINFO_S;

/**define INK attach position enum */
/**CNcomment:定义INK绑定位置枚举 */
typedef enum hiUNF_DISP_INK_POS_E
{
    HI_UNF_DISP_INK_POS_CSC_F = 0,
    HI_UNF_DISP_INK_POS_CSC_B,
    HI_UNF_DISP_INK_POS_GAMMA_F,
    HI_UNF_DISP_INK_POS_GAMMA_B,
 
    HI_UNF_DISP_INK_BUTT,
} HI_UNF_DISP_INK_POS_E;

/**define display ink func attr struct */
/**CNcomment:定义INK功能属性结构体 */
typedef struct hiUNF_DISP_INK_ATTR_S
{
    HI_UNF_DISP_INK_POS_E   enInkPos;
    HI_U32                  u32X;
    HI_U32                  u32Y;
} HI_UNF_DISP_INK_ATTR_S;

/**define video channel delay struct */
/**CNcomment:定义视频通路延时结构体 */
typedef struct hiUNF_DISP_DELAY_S
{
...
/**
   \ Set the resolution when snap screen picture;CNcomment:设置截取画面属性; CNend
   \attention \n
   none. CNcomment:无 CNend
   \param[in] u32Width      Width of resolution.CNcomment:分辨率宽度 CNend
   \param[in] u32Height     Height of resolution.CNcomment:分辨率高度 CNend
   \retval ::HI_SUCCESS CNcomment: success.成功 CNend
   \retval ::HI_ERR_DISP_NO_INIT    DISP uninitialization.CNcomment:DISP未初始化 CNend
   \retval ::HI_ERR_DISP_NULL_PTR          Input pointer is NULL.CNcomment:输入指针为空 CNend
   \retval ::HI_ERR_DISP_INVALID_PARA   invalid input parameter.CNcomment:输入参数非法 CNend
   ...
   none.CNcomment:无 CNend
 */
HI_S32 HI_UNF_DISP_SetSnapShotAttr(HI_UNF_DISP_E enDisp,HI_UNF_DISP_SNAP_ATTR_S *pstSnapAttr);
...
/**
   \brief Get right eye first for 3D output.CNcomment:设置3D输出右眼优先 CNend
   \attention \n
   Only take effect in 3D output mode. CNcomment: 仅在3D输出时有效 CNend
   \param[in] enDisp     DISP channel ID.CNcomment:DISP通道号 CNend
   \param[in] pbEnable   Pointer of ight eye firstEnable flag .CNcomment:右眼优先使能指针 CNend
   \retval ::HI_SUCCESS  success.CNcomment:成功 CNend
   \retval ::HI_ERR_DISP_NO_INIT    DISP uninitialization.CNcomment:DISP未初始化 CNend
   \retval ::HI_ERR_DISP_INVALID_PARA   invalid input parameter.CNcomment:输入参数非法 CNend
   \see \n
   none.CNcomment:无 CNend
 */
HI_S32 HI_UNF_DISP_GetRightEyeFirst(HI_UNF_DISP_E enDisp, HI_BOOL *pbEnable);
...
//NEW ADD FOR TV
/* 3D Related API, 3D LR Swith use API of STB HI_UNF_DISP_SetRightEyeFirst() */


/**
   \brief Set Video 3D Mode.CNcomment:设置视频3D播放模式 CNend
   \attention \n
   none. CNcomment: 无 CNend
   \param[in] enDisp   DISP channel ID.CNcomment:DISP通道号 CNend
   \param[in] en3DMode  Video 3D Mode.CNcomment:视频的3D播放模式. CNend
   \retval ::HI_SUCCESS  success.CNcomment:成功 CNend
   \retval ::HI_ERR_DISP_NO_INIT    DISP uninitialization.CNcomment:DISP未初始化 CNend
   \retval ::HI_ERR_DISP_INVALID_PARA   invalid input parameter.CNcomment:输入参数非法 CNend
   \see \n
   none.CNcomment:无 CNend
 */
HI_S32 HI_UNF_DISP_SetVideo3DMode(HI_UNF_DISP_E enDisp, HI_UNF_DISP_3DMODE_E en3DMode);


/**
   \brief Get Video 3D Mode.CNcomment:获取视频3D播放模式 CNend
   \attention \n
   none. CNcomment: 无 CNend
   \param[in] enDisp   DISP channel ID.CNcomment:DISP通道号 CNend
   \param[in] pen3DMode Pointer of video 3D Mode.CNcomment:视频的3D播放模式指针. CNend
   \retval ::HI_SUCCESS  success.CNcomment:成功 CNend
   \retval ::HI_ERR_DISP_NO_INIT    DISP uninitialization.CNcomment:DISP未初始化 CNend
   \retval ::HI_ERR_DISP_INVALID_PARA   invalid input parameter.CNcomment:输入参数非法 CNend
   \see \n
   none.CNcomment:无 CNend
 */
HI_S32 HI_UNF_DISP_GetVideo3DMode(HI_UNF_DISP_E enDisp, HI_UNF_DISP_3DMODE_E *pen3DMode);


/**
   \brief Get memc motion smooth level adjust range.CNcomment:获取memc运动平滑度调整范围 CNend
   \attention \n
   only take effect when Chip include Memc Module . CNcomment: 仅在芯片包含memc模块时候有效 CNend
   \param[in] enDisp   DISP channel ID.CNcomment:DISP通道号 CNend
   \param[out] pstRange Pointer of memc motion smooth level adjust range.CNcomment:memc运动平滑度调整范围指针. CNend
   \retval ::HI_SUCCESS  success.CNcomment:成功 CNend
   \retval ::HI_ERR_DISP_NO_INIT    DISP uninitialization.CNcomment:DISP未初始化 CNend
   \retval ::HI_ERR_DISP_INVALID_PARA   invalid input parameter.CNcomment:输入参数非法 CNend
   \see \n
   none.CNcomment:无 CNend
 */
HI_S32 HI_UNF_DISP_GetMemcRange(HI_UNF_DISP_E enDisp, HI_RANGE_S *pstRange);

/**
   \brief Set memc Demo enable.CNcomment:设置memc演示模式使能 CNend
   \attention \n
   only take effect when Chip include Memc Module . CNcomment: 仅在芯片包含memc模块时候有效 CNend
   \param[in] enDisp   DISP channel ID.CNcomment:DISP通道号 CNend
   \param[in] bEnable  Enable memc Demo mode.CNcomment:使能memc演示模式. CNend
   \retval ::HI_SUCCESS  success.CNcomment:成功 CNend
   \retval ::HI_ERR_DISP_NO_INIT    DISP uninitialization.CNcomment:DISP未初始化 CNend
   \retval ::HI_ERR_DISP_INVALID_PARA   invalid input parameter.CNcomment:输入参数非法 CNend
   \see \n
   none.CNcomment:无 CNend
 */
HI_S32 HI_UNF_DISP_SetMemcDemo(HI_UNF_DISP_E enDisp, HI_BOOL bEnable);

/**
   \brief Get memc Demo mode.CNcomment:获取memc演示模式 CNend
   \attention \n
   only take effect when Chip include Memc Module . CNcomment: 仅在芯片包含memc模块时候有效 CNend
   \param[in] enDisp   DISP channel ID.CNcomment:DISP通道号 CNend
   \param[out] pbEnable  pointer of memc Demo mode status.CNcomment:memc 演示模式使能状态. CNend
   \retval ::HI_SUCCESS  success.CNcomment:成功 CNend
   \retval ::HI_ERR_DISP_NO_INIT    DISP uninitialization.CNcomment:DISP未初始化 CNend
   \retval ::HI_ERR_DISP_INVALID_PARA   invalid input parameter.CNcomment:输入参数非法 CNend
   \see \n
   none.CNcomment:无 CNend
 */
HI_S32 HI_UNF_DISP_GetMemcDemo(HI_UNF_DISP_E enDisp, HI_U32 *pbEnable);


/**
   \brief Set memc motion smooth level.CNcomment:设置memc运动平滑度值 CNend
   \attention \n
   only take effect when Chip include Memc Module . CNcomment: 仅在芯片包含memc模块时候有效 CNend
   \param[in] enDisp   DISP channel ID.CNcomment:DISP通道号 CNend
   \param[in] u32MemcLevel  memc motion smooth level.CNcomment:memc运动平滑度值 CNend
   \retval ::HI_SUCCESS  success.CNcomment:成功 CNend
   \retval ::HI_ERR_DISP_NO_INIT    DISP uninitialization.CNcomment:DISP未初始化 CNend
   \retval ::HI_ERR_DISP_INVALID_PARA   invalid input parameter.CNcomment:输入参数非法 CNend
   \see \n
   none.CNcomment:无 CNend
 */
HI_S32 HI_UNF_DISP_SetMemcLevel(HI_UNF_DISP_E enDisp, HI_U32 u32MemcLevel);

/**
   \brief Get memc motion smooth level.CNcomment:获取memc运动平滑度值 CNend
   \attention \n
   only take effect when Chip include Memc Module . CNcomment: 仅在芯片包含memc模块时候有效 CNend
   \param[in] enDisp   DISP channel ID.CNcomment:DISP通道号 CNend
   \param[out] pu32MemcLevel  memc motion smooth level.CNcomment:memc运动平滑度值指针 CNend
   \retval ::HI_SUCCESS  success.CNcomment:成功 CNend
   \retval ::HI_ERR_DISP_NO_INIT    DISP uninitialization.CNcomment:DISP未初始化 CNend
   \retval ::HI_ERR_DISP_INVALID_PARA   invalid input parameter.CNcomment:输入参数非法 CNend
   \see \n
   none.CNcomment:无 CNend
 */
HI_S32 HI_UNF_DISP_GetMemcLevel(HI_UNF_DISP_E enDisp,  HI_U32 *pu32MemcLevel);


/**
   \brief Set memc enable.CNcomment:设置memc使能 CNend
   \attention \n
   only take effect when Chip include Memc Module . CNcomment: 仅在芯片包含memc模块时候有效 CNend
   \param[in] enDisp   DISP channel ID.CNcomment:DISP通道号 CNend
   \param[in] bEnable  enable memc.CNcomment:使能memc CNend
   \retval ::HI_SUCCESS  success.CNcomment:成功 CNend
   \retval ::HI_ERR_DISP_NO_INIT    DISP uninitialization.CNcomment:DISP未初始化 CNend
   \retval ::HI_ERR_DISP_INVALID_PARA   invalid input parameter.CNcomment:输入参数非法 CNend
   \see \n
   none.CNcomment:无 CNend
 */
HI_S32 HI_UNF_DISP_SetMemcEnable(HI_UNF_DISP_E enDisp, HI_BOOL bEnable);

/**
   \brief Get memc enable.CNcomment:获取memc使能 CNend
   \attention \n
   only take effect when Chip include Memc Module . CNcomment: 仅在芯片包含memc模块时候有效 CNend
   \param[in] enDisp   DISP channel ID.CNcomment:DISP通道号 CNend
   \param[out] pbEnable  get memc status.CNcomment:memc使能状态指针 CNend
   \retval ::HI_SUCCESS  success.CNcomment:成功 CNend
   \retval ::HI_ERR_DISP_NO_INIT    DISP uninitialization.CNcomment:DISP未初始化 CNend
   \retval ::HI_ERR_DISP_INVALID_PARA   invalid input parameter.CNcomment:输入参数非法 CNend
   \see \n
   none.CNcomment:无 CNend
 */
HI_S32 HI_UNF_DISP_GetMemcEnable(HI_UNF_DISP_E enDisp, HI_BOOL *pbEnable);

/**
   \brief Set flip enable.CNcomment:设置flip使能 CNend
   \attention \n
   none . CNcomment: 无 CNend
   \param[in] enDisp   DISP channel ID.CNcomment:DISP通道号 CNend
   \param[in] bHorFlip  Horizontal flip enable .CNcomment:使能水平翻转 CNend
   \param[in] bVerFlip  Vertical flip enable .CNcomment:使能垂直翻转 CNend
   \retval ::HI_SUCCESS  success.CNcomment:成功 CNend
   \retval ::HI_ERR_DISP_NO_INIT    DISP uninitialization.CNcomment:DISP未初始化 CNend
   \retval ::HI_ERR_DISP_INVALID_PARA   invalid input parameter.CNcomment:输入参数非法 CNend
   \see \n
   none.CNcomment:无 CNend
 */
HI_S32 HI_UNF_DISP_SetFlip(HI_UNF_DISP_E enDisp, HI_BOOL bHorFlip, HI_BOOL bVerFlip);

/**
   \brief Get flip enable.CNcomment:获取flip使能 CNend
   \attention \n
   none . CNcomment: 无 CNend
   \param[in] enDisp   DISP channel ID.CNcomment:DISP通道号 CNend
   \param[in] pbHorFlip  Pointer of Horizontal flip enable .CNcomment:使能水平翻转状态指针 CNend
   \param[in] pbVerFlip  Pointer of Vertical flip enable .CNcomment:使能垂直翻转状态指针 CNend
   \retval ::HI_SUCCESS  success.CNcomment:成功 CNend
   \retval ::HI_ERR_DISP_NO_INIT    DISP uninitialization.CNcomment:DISP未初始化 CNend
   \retval ::HI_ERR_DISP_INVALID_PARA   invalid input parameter.CNcomment:输入参数非法 CNend
   \see \n
   none.CNcomment:无 CNend
 */
HI_S32 HI_UNF_DISP_GetFlip(HI_UNF_DISP_E enDisp, HI_BOOL *pbHorFlip, HI_BOOL *pbVerFlip);


/**
   \brief set colorbar test pattern enable.CNcomment:使能colorbar测试pattern CNend
   \attention \n
   none . CNcomment: 无 CNend
   \param[in] enDisp   DISP channel ID.CNcomment:DISP通道号 CNend
   \param[in] bEnable  enable colorbar.CNcomment:使能 colorbar CNend
   \retval ::HI_SUCCESS  success.CNcomment:成功 CNend
   \retval ::HI_ERR_DISP_NO_INIT    DISP uninitialization.CNcomment:DISP未初始化 CNend
   \retval ::HI_ERR_DISP_INVALID_PARA   invalid input parameter.CNcomment:输入参数非法 CNend
   \see \n
   none.CNcomment:无 CNend
 */
HI_S32 HI_UNF_DISP_SetColorBarEnable(HI_UNF_DISP_E enDisp, HI_BOOL bEnable);


/**
   \brief Get colorbar enable.CNcomment:获取colorbar使能 CNend
   \attention \n
   none . CNcomment: 无 CNend
   \param[in] enDisp   DISP channel ID.CNcomment:DISP通道号 CNend
   \param[out] pbEnable  get colorbar eable status.CNcomment:color使能状态指针 CNend
   \retval ::HI_SUCCESS  success.CNcomment:成功 CNend
   \retval ::HI_ERR_DISP_NO_INIT    DISP uninitialization.CNcomment:DISP未初始化 CNend
   \retval ::HI_ERR_DISP_INVALID_PARA   invalid input parameter.CNcomment:输入参数非法 CNend
   \see \n
   none.CNcomment:无 CNend
 */
HI_S32 HI_UNF_DISP_GetColorBarEnable(HI_UNF_DISP_E enDisp, HI_BOOL *pbEnable);


/**
   \brief set test pattern enable.CNcomment:使能测试pattern CNend
   \attention \n
   none . CNcomment: 无 CNend
   \param[in] enDisp   DISP channel ID.CNcomment:DISP通道号 CNend
   \param[in] bEnable  enable Testpattern.CNcomment:使能 Testpattern CNend
   \param[in] pstColor Testpattern Color.CNcomment:Testpattern颜色指针 CNend
   \retval ::HI_SUCCESS  success.CNcomment:成功 CNend
   \retval ::HI_ERR_DISP_NO_INIT    DISP uninitialization.CNcomment:DISP未初始化 CNend
   \retval ::HI_ERR_DISP_INVALID_PARA   invalid input parameter.CNcomment:输入参数非法 CNend
   \see \n
   none.CNcomment:无 CNend
 */
HI_S32 HI_UNF_DISP_SetTestPattern(HI_UNF_DISP_E enDisp, HI_BOOL bEnable, HI_UNF_DISP_BG_COLOR_S pstColor);

/**
   \brief Get Testpattern enable.CNcomment:获取Testpattern使能 CNend
   \attention \n
   none . CNcomment: 无 CNend
   \param[in] enDisp   DISP channel ID.CNcomment:DISP通道号 CNend
   \param[out] pbEnable  get Testpattern eable status.CNcomment:Testpattern使能状态 CNend
   \param[out] pstColor Testpattern Color.CNcomment:Testpattern颜色指针 CNend
   \retval ::HI_SUCCESS  success.CNcomment:成功 CNend
   \retval ::HI_ERR_DISP_NO_INIT    DISP uninitialization.CNcomment:DISP未初始化 CNend
   \retval ::HI_ERR_DISP_INVALID_PARA   invalid input parameter.CNcomment:输入参数非法 CNend
   \see \n
   none.CNcomment:无 CNend
 */
HI_S32 HI_UNF_DISP_GetTestPattern(HI_UNF_DISP_E enDisp, HI_BOOL *pbEnable, HI_UNF_DISP_BG_COLOR_S *pstColor);


/**
   \brief set Virtual Video Screen resolution.CNcomment:设置视频虚拟屏幕分辨率 CNend
   \attention \n
   none . CNcomment: 无 CNend
   \param[in] enDisp   DISP channel ID.CNcomment:DISP通道号 CNend
   \param[in] u32Width  Virtual Screen width,the range is [480, 3840].CNcomment:视频虚拟屏幕宽度,取值范围为[480, 3840]
   \param[in] u32Width  Virtual Screen height,the range is [480, 3840].CNcomment:视频虚拟屏幕高度,取值范围为[480, 3840]
   \retval ::HI_SUCCESS  success.CNcomment:成功 CNend
   \retval ::HI_ERR_DISP_NO_INIT    DISP uninitialization.CNcomment:DISP未初始化 CNend
   \retval ::HI_ERR_DISP_INVALID_PARA   invalid input parameter.CNcomment:输入参数非法 CNend
   \see \n
   none.CNcomment:无 CNend
 */
HI_S32 HI_UNF_DISP_SetVideoVirtualScreen(HI_UNF_DISP_E enDisp, HI_U32 u32Width, HI_U32 u32Height);


/**
   \brief Get Virtual Video Screen resolution.CNcomment:获取视频虚拟屏幕分辨率 CNend
   \attention \n
   none . CNcomment: 无 CNend
   \param[in] enDisp   DISP channel ID.CNcomment:DISP通道号 CNend
   \param[in] pu32Width  pointer of Virtual Screen width.CNcomment:视频虚拟屏幕宽度指针
   \param[in] pu32Height pointer of Virtual Screen height.CNcomment:视频虚拟屏幕高度指针
   \retval ::HI_SUCCESS  success.CNcomment:成功 CNend
   \retval ::HI_ERR_DISP_NO_INIT    DISP uninitialization.CNcomment:DISP未初始化 CNend
   \retval ::HI_ERR_DISP_INVALID_PARA   invalid input parameter.CNcomment:输入参数非法 CNend
   \see \n
   none.CNcomment:无 CNend
 */
HI_S32 HI_UNF_DISP_GetVideoVirtualScreen(HI_UNF_DISP_E enDisp, HI_U32 *pu32Width, HI_U32 *pu32Height);


/**
   \brief Get DISP displayInfo.CNcomment:获取display运行状态信息 CNend
   \attention \n
   none . CNcomment: 无 CNend
   \param[in] enDisp   DISP channel ID.CNcomment:DISP通道号 CNend
   \param[out] pstDisplayInfo  pointer of DisplayInfo.CNcomment:display运行状态信息指针 CNend
   \retval ::HI_SUCCESS  success.CNcomment:成功 CNend
   \retval ::HI_ERR_DISP_NO_INIT    DISP uninitialization.CNcomment:DISP未初始化 CNend
   \retval ::HI_ERR_DISP_INVALID_PARA   invalid input parameter.CNcomment:输入参数非法 CNend
   \see \n
   none.CNcomment:无 CNend
 */
HI_S32 HI_UNF_DISP_GetDisplayInfo(HI_UNF_DISP_E enDisp, HI_UNF_DISP_DISPLAYINFO_S *pstDisplayInfo);


/**
   \brief Get Ink RGB data.CNcomment:获取当前显示的一个坐标点的RGB数据 CNend
   \attention \n
   none . CNcomment: 无 CNend
   \param[in] enDisp   DISP channel ID.CNcomment:DISP通道号 CNend
   \param[in] pstInkAttr  ink attr .CNcomment:ink的属性，包括在vdp中的位置，屏幕坐标，是否显示十字坐标
   \param[in] pstInkRGB ink RGB data.CNcomment:获取到的RGB数据
   \retval ::HI_SUCCESS  success.CNcomment:成功 CNend
   \retval ::HI_ERR_DISP_NO_INIT    DISP uninitialization.CNcomment:DISP未初始化 CNend
   \retval ::HI_ERR_DISP_INVALID_PARA   invalid input parameter.CNcomment:输入参数非法 CNend
   \see \n
...
HI_S32 HI_UNF_DISP_GetInkRGB(HI_UNF_DISP_E enDisp, HI_UNF_DISP_INK_ATTR_S *pstInkAttr , HI_COLOR_S *pstInkRGB);

/**
   \brief Set interface delay .CNcomment:设置通道延时参数 CNend
   \attention \n
   none . CNcomment: 无 CNend
   \param[in] enDisp   DISP channel ID.CNcomment:DISP通道号 CNend
   \param[in] pstDelayAttr  delay attr .CNcomment:delay的属性，包括在Panel上面MEMC延时信息等
   \retval ::HI_SUCCESS  success.CNcomment:成功 CNend
   \retval ::HI_ERR_DISP_NO_INIT    DISP uninitialization.CNcomment:DISP未初始化 CNend
   \retval ::HI_ERR_DISP_INVALID_PARA   invalid input parameter.CNcomment:输入参数非法 CNend
   \see \n
   none.CNcomment:无 CNend
 */
HI_S32 HI_UNF_DISP_SetChnDelay(HI_UNF_DISP_E enDisp, HI_UNF_DISP_DELAY_S *pstDelayAttr);

/**
   \brief Get interface delay .CNcomment:获取通道延时参数 CNend
   \attention \n
   none . CNcomment: 无 CNend
   \param[in] enDisp   DISP channel ID.CNcomment:DISP通道号 CNend
   \param[in] pstDelayAttr  delay attr .CNcomment:delay的属性，包括在Panel上面MEMC延时信息等
...
HI_S32 HI_UNF_DISP_GetChnDelay(HI_UNF_DISP_E enDisp, HI_UNF_DISP_DELAY_S *pstDelayAttr);
