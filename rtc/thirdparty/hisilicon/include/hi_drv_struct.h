...
#define HI_MOD_SWITCH                "switch"
#define UMAP_DEVNAME_SWITCH             UMAP_NAME HI_MOD_SWITCH 
#define UMAP_DEV_NUM_SWITCH             1
#define UMAP_MIN_MINOR_SWITCH           (UMAP_MAX_MINOR_VBI + 1)
#define UMAP_MAX_MINOR_SWITCH           (UMAP_MIN_MINOR_SWITCH + UMAP_DEV_NUM_SWITCH -1)

/* Add by QWB 20160728 */
#define HI_MOD_STM32                 "stm32"
#define UMAP_DEVNAME_STM32           UMAP_NAME HI_MOD_STM32
#define UMAP_DEV_NUM_STM32           1
#define UMAP_MIN_MINOR_STM32         (UMAP_MAX_MINOR_SWITCH + 1)
#define UMAP_MAX_MINOR_STM32         (UMAP_MIN_MINOR_STM32 + UMAP_DEV_NUM_STM32 -1)

#define UMAP_DEV_NUM_TOTAL          UMAP_MIN_MINOR_STM32
