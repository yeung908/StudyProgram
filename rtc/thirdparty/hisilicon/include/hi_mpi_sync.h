...
HI_S32 HI_MPI_SYNC_GetPreSyncStatus(HI_HANDLE hSync, HI_BOOL *bPreSyncFinish);
HI_S32 HI_MPI_SYNC_SetSyncTarget(HI_HANDLE hSync, HI_UNF_SYNC_REF_E enSyncRef);
