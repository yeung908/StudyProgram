...
HI_S32 HI_MPI_AVPLAY_AcqUserDataExt(HI_HANDLE hAvplay, HI_UNF_VIDEO_USERDATA_TYPE_E enType,HI_UNF_VIDEO_USERDATA_S *pstUserData);
HI_S32 HI_MPI_AVPLAY_RlsUserDataExt(HI_HANDLE hAvplay, HI_UNF_VIDEO_USERDATA_TYPE_E enType,HI_UNF_VIDEO_USERDATA_S* pstUserData);

HI_S32 HI_MPI_AVPLAY_GetVidChnOpenParam(HI_HANDLE hAvplay, HI_UNF_AVPLAY_OPEN_OPT_S *pstOpenPara);
HI_S32 HI_MPI_AVPLAY_GetFrmPackingType(HI_HANDLE hAvplay, HI_UNF_VIDEO_FRAME_PACKING_TYPE_E *pFrmPackingType);
HI_S32 HI_MPI_AVPLAY_SetFrmPackingType(HI_HANDLE hAvplay, HI_UNF_VIDEO_FRAME_PACKING_TYPE_E *pFrmPackingType);
HI_S32 HI_MPI_AVPLAY_GetGlobalPlayInfo(HI_HANDLE hAvplay, HI_UNF_AVPLAY_GLOBAL_PLAY_INFO_S *pstPlayInfo);
HI_S32 HI_MPI_AVPLAY_GetHandleByWindow(HI_HANDLE hWindow, HI_HANDLE *phAvplay);
HI_S32 HI_MPI_AVPLAY_GetVideoFrameInfo(HI_HANDLE hAvplay, HI_UNF_AVPLAY_VIDEO_FRAME_INFO_S *pstVideoFrameInfo);
HI_S32 HI_MPI_AVPLAY_Set3DDetect(HI_HANDLE hAvplay, HI_UNF_AVPLAY_3D_DETECT_ATTR_S *pst3dDetectAttr);
HI_S32 HI_MPI_AVPLAY_Get3DResult(HI_HANDLE hAvplay, HI_UNF_VIDEO_FRAME_PACKING_TYPE_E *pst3dFormat);
HI_S32 HI_MPI_AVPLAY_UseExternalBuffer(HI_HANDLE hAvplay, HI_HANDLE* phBuffers, HI_U32 u32Cnt, HI_U32 u32Size, HI_U32 u32Stride);
HI_S32 HI_MPI_AVPLAY_DeleteExternalBuffer(HI_HANDLE hAvplay, HI_HANDLE* phBuffers, HI_U32 u32Cnt);
