...
#elif  defined(CHIP_TYPE_hi3751v500) || defined(CHIP_TYPE_hi3751v300)
#define     HI_GPIO_GROUP_NUM 18
#else
...
#define HI_GPIO_REG_REMAP(pvAddr, u32RegAddr)   \
    do {\
        pvAddr = ioremap_nocache(u32RegAddr, HI_GPIO_SPACE_SIZE);\
        if (NULL == pvAddr)\
        {\
            HI_ERR_GPIO("ioremap REG_ADDR[0x%x] failure!\n", u32RegAddr);\
            return HI_FAILURE;\
        }\
    } while (0)

#define HI_GPIO_REG_UNMAP(pvAddr)   iounmap(pvAddr)
...
#define     HI_GPIO_16_ADDR 0xF8B30000
#define     HI_GPIO_17_ADDR 0xF8B31000
#define     HI_GPIO_18_ADDR 0xF8004000  /* GPIO_STB0 */
#define     HI_GPIO_19_ADDR 0xF8009000  /* GPIO_STB1 */

#elif  defined(CHIP_TYPE_hi3751v500) || defined(CHIP_TYPE_hi3751v300)

#define 	HI_GPIO_MAX_GROUP_NUM	18

#define     HI_GPIO_IRQ_STB0_NO (126 + 32)
#define     HI_GPIO_IRQ_STB1_NO (127 + 32)
#define     HI_GPIO_IRQ_STB2_NO (32 + 32)

#define     HI_GPIO_IRQ_NO (109 + 32)

#define     HI_GPIO_0_ADDR 0xF8004000  /* GPIO_STB0 */
#define     HI_GPIO_1_ADDR 0xF8009000  /* GPIO_STB1 */
#define     HI_GPIO_2_ADDR 0xF800B000  /* GPIO_STB2 */
#define     HI_GPIO_3_ADDR 0xF8B20000
#define     HI_GPIO_4_ADDR 0xF8B21000
#define     HI_GPIO_5_ADDR 0xF8B22000
#define     HI_GPIO_6_ADDR 0xF8B23000
#define     HI_GPIO_7_ADDR 0xF8B24000
#define     HI_GPIO_8_ADDR 0xF8B25000
#define     HI_GPIO_9_ADDR 0xF8B26000
#define     HI_GPIO_10_ADDR 0xF8B27000
#define     HI_GPIO_11_ADDR 0xF8B28000
#define     HI_GPIO_12_ADDR 0xF8B29000
#define     HI_GPIO_13_ADDR 0xF8B2A000
#define     HI_GPIO_14_ADDR 0xF8B2B000
#define     HI_GPIO_15_ADDR 0xF8B2C000
#define     HI_GPIO_16_ADDR 0xF8B2D000
#define     HI_GPIO_17_ADDR 0xF8B2E000
