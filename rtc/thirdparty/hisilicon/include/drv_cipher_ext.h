...
typedef HI_S32 (*FN_CIPHER_CreateHandle)(CIPHER_HANDLE_S * pstCIHandle);
...
typedef HI_S32 (*FN_CIPHER_EncryptMulti)(CIPHER_DATA_EXT_S * pstCIData);
typedef HI_S32 (*FN_CIPHER_DecryptMulti)(CIPHER_DATA_EXT_S * pstCIData);
typedef HI_S32 (*FN_CIPHER_GetRandomNumber)(HI_U32 * pu32RngRandomNumber);
...
typedef HI_S32 (*FN_CIPHER_LoadAesKey)(HI_U8 *pu32Key,HI_U32 u32Len);
...
typedef struct
{
    ...
    FN_CIPHER_LoadAesKey        pfnCipherLoadAesKey;
