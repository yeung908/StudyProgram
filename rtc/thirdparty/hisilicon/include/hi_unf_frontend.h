...
#define UNF_TUNER_NUM                   5   /** Tuner ID unmber */                          /** CNcomment:Tuner ID个数*/
...
{
    HI_UNF_TUNER_SAMPLE_DATALEN_32,    /*sample 32 pts*/   /**<CNcomment:采集32点*/
    HI_UNF_TUNER_SAMPLE_DATALEN_64,    /*sample 64 pts*/   /**<CNcomment:采集64点*/
    HI_UNF_TUNER_SAMPLE_DATALEN_128,   /*sample 128 pts*/  /**<CNcomment:采集128点*/
    HI_UNF_TUNER_SAMPLE_DATALEN_256,   /*sample 256 pts*/  /**<CNcomment:采集256点*/
...
typedef enum hiUNF_QAM_TYPE_E
{
    ...
    HI_UNF_MOD_TYPE_DQPSK,            /**<Enumeration corresponding to (DQPSK) mode*/                                                    /**<CNcomment:DQPSK对应的枚举值*/
...
{
    HI_UNF_TUNER_SIG_TYPE_CAB = 0  ,   /**<Cable signal*/       /**<CNcomment:ITU-T J.83 ANNEX A/C(DVB_C)信号信号*/
    ...
    HI_UNF_TUNER_SIG_TYPE_J83B  ,      /**<Cable signal*/       /**<CNcomment:ITU-T J.83 ANNEX B(US Cable)信号*/
    HI_UNF_TUNER_SIG_TYPE_ATV,         /**<Analog RF signal*/   /**<CNcomment:模拟电视信号，ATV新增*/
...
typedef enum    hiUNF_TUNER_DEV_TYPE_E
{
    ...
    HI_UNF_TUNER_DEV_TYPE_MXL254,               /**<MXL254*/                     /**<CNcomment:支持MXL254高频头*/
    HI_UNF_TUNER_DEV_TYPE_CXD2861,              /**<CXD2861*/                    /**<CNcomment:支持CXD2861高频头*/
    HI_UNF_TUNER_DEV_TYPE_TDA18273,			        /**<TDA18273*/				           /**<CNcomment:支持TDA18273高频头*/    
    HI_UNF_TUNER_DEV_TYPE_TDA18275, 			      /**<TDA18275*/			             /**<CNcomment:支持TDA18275高频头*/
    HI_UNF_TUNER_DEV_TYPE_R840,                 /**<R840*/				               /**<CNcomment:支持R840高频头*/  
    HI_UNF_TUNER_DEV_TYPE_MXL661,               /**<mxl661*/			   /**<CNcomment:支持MXL661高频头*/
    HI_UNF_TUNER_DEV_TYPE_MXL601,               /**<mxl601*/			   /**<CNcomment:支持MXL601高频头*/
	HI_UNF_TUNER_DEV_TYPE_TDA18275A,            /**<TDA18275A*/			             /**<CNcomment:支持TDA18275A高频头*/
	HI_UNF_TUNER_DEV_TYPE_SI2151,				/**<si2151*/			  /**<CNcomment:支持si2151高频头*/
    HI_UNF_TUNER_DEV_TYPE_R842,                 /**<R842*/				               /**<CNcomment:支持R842高频头*/  
...
typedef enum    hiUNF_DEMOD_DEV_TYPE_E
{
    ...
    HI_UNF_DEMOD_DEV_TYPE_TDA8296I,            /**<Internal TDA8296*/   /**<CNcomment:内部TDA8296*/
    HI_UNF_DEMOD_DEV_TYPE_ATBM8878,            /**<Internal ATBM8878*/	/**<CNcomment:外部ATBM8878*/
    HI_UNF_DEMOD_DEV_TYPE_HIDTV100,            /**<Internal HIDTV100*/	/**<CNcomment:内部HIDTV100*/
    HI_UNF_DEMOD_DEV_TYPE_AVL6381,            /**<Internal AVL6381*/	/**<CNcomment:外部AVL6381*/
    HI_UNF_DEMOD_DEV_TYPE_ATBM7823,         /**<External ATBM7823*/    /**<CNcomment:外部ATBM7823芯片*/
...
/** CNcomment:ATV信号信息*/
typedef struct hiUNF_TUNER_ATV_SIGNALINFO_S
{
    HI_BOOL bVifLock;           /**< IF locked information or not */       /* 中频是否锁定 */
    HI_BOOL bAfcWin;            /**< In the AFC window or not */           /* 是否在AFC窗口里面 */
    HI_BOOL bCarrDet;           /**< Detected the audio carrier or not */  /* 调频伴音载波检测 */
    HI_S32  s32AfcFreq;         /**< AFC frequency information */          /* AFC频率值，单位Khz */
} HI_UNF_TUNER_ATV_SIGNALINFO_S;

/** DTMB carrier type.*/
/** CNcomment:DTMB 载波类型*/
typedef enum hiUNF_TUNER_DTMB_CARRIER_MODE_E
{   
    HI_UNF_TUNER_DTMB_CARRIER_UNKNOWN = 0,  /**<unknown type*/            /**<CNcomment:未知类型*/   
    HI_UNF_TUNER_DTMB_CARRIER_SINGLE,       /**<single type*/             /**<CNcomment:单载波*/   
    HI_UNF_TUNER_DTMB_CARRIER_MULTI         /**<multi type*/              /**<CNcomment:多载波*/   
}HI_UNF_TUNER_DTMB_CARRIER_MODE_E;

/** DTMB QAM type.*/
/** CNcomment:DTMB 调制类型*/
typedef enum hiUNF_TUNER_DTMB_QAM_INDEX_E
{
    HI_UNF_TUNER_DTMB_QAM_UNKNOWN = 0, /**<unknown type*/      /**<CNcomment:未知类型*/
    HI_UNF_TUNER_DTMB_QAM_4QAM_NR,     /**<4QAM_NR type*/      /**<CNcomment:4QAM_NR 调制*/
    HI_UNF_TUNER_DTMB_QAM_4QAM,        /**<single type*/       /**<CNcomment:4QAM 调制*/
    HI_UNF_TUNER_DTMB_QAM_16QAM,       /**<single type*/       /**<CNcomment:16QAM 调制*/
    HI_UNF_TUNER_DTMB_QAM_32QAM,       /**<single type*/       /**<CNcomment:32QAM 调制*/
    HI_UNF_TUNER_DTMB_QAM_64QAM        /**<single type*/       /**<CNcomment:64QAM 调制*/
}HI_UNF_TUNER_DTMB_QAM_INDEX_E;

/** DTMB code rate type.*/
/** CNcomment:DTMB 码率类型*/
typedef enum hiUNF_TUNER_DTMB_CODE_RATE_E
{
    HI_UNF_TUNER_DTMB_CODE_RATE_UNKNOWN = 0, /**<unknown type*/  /**<CNcomment:未知类型*/
    HI_UNF_TUNER_DTMB_CODE_RATE_0_DOT_4,     /**<0.4 type*/      /**<CNcomment:0.4 码率*/
    HI_UNF_TUNER_DTMB_CODE_RATE_0_DOT_6,     /**<0.6 type*/      /**<CNcomment:0.6 码率*/
    HI_UNF_TUNER_DTMB_CODE_RATE_0_DOT_8      /**<0.8 type*/      /**<CNcomment:0.8 码率*/
}HI_UNF_TUNER_DTMB_CODE_RATE_E;

/** DTMB time interleaving type.*/
/** CNcomment:DTMB 时域交织类型*/
typedef enum hiUNF_TUNER_DTMB_TIME_INTERLEAVE_E
{
    HI_UNF_TUNER_DTMB_TIME_INTERLEAVER_UNKNOWN = 0, /**<unknown type*/  /**<CNcomment:未知类型*/
    HI_UNF_TUNER_DTMB_TIME_INTERLEAVER_240,         /**<240 type*/      /**<CNcomment:240 类型*/
    HI_UNF_TUNER_DTMB_TIME_INTERLEAVER_720          /**<720 type*/      /**<CNcomment:720 类型*/
}HI_UNF_TUNER_DTMB_TIME_INTERLEAVE_E;

/** DTMB guard interval type.*/
/** CNcomment:DTMB 保护间隔类型*/
typedef enum hiUNF_TUNER_DTMB_GUARD_INTERVAL_E
{
    HI_UNF_TUNER_DTMB_GI_UNKNOWN = 0,   /**<unknown type*/      /**<CNcomment:未知类型*/
    HI_UNF_TUNER_DTMB_GI_420,           /**<420 type*/          /**<CNcomment:420 类型*/
    HI_UNF_TUNER_DTMB_GI_595,           /**<595 type*/          /**<CNcomment:595 类型*/
    HI_UNF_TUNER_DTMB_GI_945            /**<945 type*/          /**<CNcomment:945 类型*/
}HI_UNF_TUNER_DTMB_GUARD_INTERVAL_E;


/** DTMB signal information.*/
/** CNcomment:DTMB信号信息*/
typedef struct hiUNF_TUNER_DTMB_SIGNALINFO_S
{
    HI_UNF_TUNER_DTMB_CARRIER_MODE_E    enCarrierMode;    /**<Carrier type*/          /**<CNcomment:载波类型*/
    HI_UNF_TUNER_DTMB_QAM_INDEX_E       enQamIndex;       /**<QAM type*/              /**<CNcomment:调制类型*/
    HI_UNF_TUNER_DTMB_CODE_RATE_E       enCodeRate;       /**<Code rate type*/        /**<CNcomment:码率类型*/
    HI_UNF_TUNER_DTMB_TIME_INTERLEAVE_E enTimeInterleave; /**<Time interleave type*/  /**<CNcomment:时域交织类型*/
    HI_UNF_TUNER_DTMB_GUARD_INTERVAL_E  enGuardInterval;  /**<Guard interval type*/   /**<CNcomment:保护时间类型*/
} HI_UNF_TUNER_DTMB_SIGNALINFO_S;
...
typedef struct hiUNF_TUNER_SIGNALINFO_S
{
    ...
    union
    {
        ...
        HI_UNF_TUNER_ATV_SIGNALINFO_S stAtv;        /* ATV信号信息*/
        HI_UNF_TUNER_DTMB_SIGNALINFO_S stDtmb;      /*DTMB信号参数*/
    } unSignalInfo;
...
/** tuner attribution*/
/** CNcomment:ATV制式信息*/
typedef enum hiUNF_ATV_SYSTEM_E
{
    HI_UNF_ATV_SYSTEM_PAL_BG = 0,       /**<PAL BG TV sytem*/  /**<CNcomment:PAL BG电视制式*/
    HI_UNF_ATV_SYSTEM_PAL_DK,           /**<PAL DK TV sytem*/  /**<CNcomment:PAL DK电视制式*/
    HI_UNF_ATV_SYSTEM_PAL_I,            /**<PAL I TV sytem*/   /**<CNcomment:PAL I电视制式*/
    HI_UNF_ATV_SYSTEM_PAL_M,            /**<PAL M TV sytem*/   /**<CNcomment:PAL M电视制式*/
    HI_UNF_ATV_SYSTEM_PAL_N,            /**<PAL N TV sytem*/   /**<CNcomment:PAL N电视制式*/
    HI_UNF_ATV_SYSTEM_SECAM_BG,         /**<SECAM BG TV sytem*/  /**<CNcomment:SECAM BG电视制式*/
    HI_UNF_ATV_SYSTEM_SECAM_DK,         /**<SECAM DK TV sytem*/  /**<CNcomment:SECAM DK电视制式*/
    HI_UNF_ATV_SYSTEM_SECAM_L_PRIME,    /**<SECAM L PRIME TV sytem*/  /**<CNcomment:SECAM L PRIME电视制式*/
    HI_UNF_ATV_SYSTEM_SECAM_LL,         /**<SECAM LL TV sytem*/  /**<CNcomment:SECAM LL电视制式*/
    HI_UNF_ATV_SYSTEM_NTSC_M,           /**<NTSC M TV sytem*/    /**<CNcomment:NTSC M电视制式*/
    HI_UNF_ATV_SYSTEM_NTSC_I,           /**<NTSC I TV sytem*/    /**<CNcomment:NTSC I 电视制式*/
    HI_UNF_ATV_SYSTEM_NTSC_DK,          /**<NTSC DK TV sytem*/    /**<CNcomment:NTSC DK电视制式*/

    HI_UNF_ATV_SYSTEM_BUTT              /**<Invalid value*/      /**<CNcomment:非法边界值*/
} HI_UNF_ATV_SYSTEM_E;

typedef enum hiUNF_ATV_SIF_BW_E
{
    HI_UNF_ATV_SIF_BW_WIDE = 0,  /* For Auto Scan Mode */
    HI_UNF_ATV_SIF_BW_NORMAL,    /* For Normal Play Mode */
    HI_UNF_ATV_SIF_BW_NARROW,    /* Not Recommended */
    
    HI_UNF_ATV_SIF_BW_BUTT
} HI_UNF_ATV_SIF_BW_E;


typedef enum hiUNF_ATV_CONNECT_WORK_MODE_E
{
    HI_UNF_ATV_CONNECT_WORK_MODE_NORMAL = 0,   /**<TVD work mode normal*/ /**<CNcomment:connect 正常工作模式 */
    HI_UNF_ATV_CONNECT_WORK_MODE_CHAN_SCAN,    /**<TVD RF channel scan mode*/ /**<CNcomment:connect RF搜台模式 */
	
    HI_UNF_ATV_CONNECT_WORK_MODE_BUTT,         /**<Invalid value*//**<CNcomment:非法边界值*/
} HI_UNF_ATV_CONNECT_WORK_MODE_E;


/* ATV传输信号参数 */
typedef struct hiUNF_ATV_CONNECT_PARA_S
{
    HI_U32                      u32Freq;    /* 频率，单位khz */
    HI_UNF_ATV_SYSTEM_E         enSystem;   /* ATV制式 */
    HI_UNF_ATV_SIF_BW_E         enSifBw;    /* Atv sif bandwidth */
	HI_UNF_ATV_CONNECT_WORK_MODE_E      enConnectWorkMode; /*connect mode :scan or switch */
	
} HI_UNF_ATV_CONNECT_PARA_S;


/** CNcomment:TUNER属性*/
typedef struct  hiUNF_TUNER_ATTR_S
{
    ...
    HI_U32	u32DemodAddr;                       /**<QThe i2c address of demod, if demod type is 3130I,3130E or J83B, you cannot set it*/
...
typedef struct  hiUNF_TUNER_CONNECT_PARA_S
{
    ...
    union
    {
        ...
        HI_UNF_ATV_CONNECT_PARA_S stAtv;       /**<Analog RF signal*/                  /**<CNcomment:ATV 传输信号，ATV新增 */
    } unConnectPara;
...
typedef enum hiUNF_TUNER_STEP_E
{
    HI_UNF_TUNER_STEP_50KHz = 0, /**<Frequency step is 50KHz*/      /**<CNcomment:50KHz步长*/
    HI_UNF_TUNER_STEP_62_5KHz,   /**<Frequency step is 62.5KHz*/    /**<CNcomment:62.5KHz步长*/
    HI_UNF_TUNER_STEP_31_25KHz,  /**<Frequency step is 31.25KHz*/   /**<CNcomment:31.25Hz步长*/
    
    HI_UNF_TUNER_STEP_BUTT,      /**<Invalid value*/                /**<CNcomment:非法边界值*/
} HI_UNF_TUNER_STEP_E;

/** Band for ATV*/
/** CNcomment:ATV波段*/
typedef enum hiUNF_TUNER_ATVBAND_E
{
    HI_UNF_TUNER_ATVBAND_VHF_LOW = 0,   /**<Low VHF band*/             /**<CNcomment: 低甚高频段*/
    HI_UNF_TUNER_ATVBAND_VHF_HIGH,      /**<High VHF band*/            /**<CNcomment: 高甚高频段*/
    HI_UNF_TUNER_ATVBAND_UHF,           /**<UHF band*/                 /**<CNcomment: 超高频段*/
    HI_UNF_TUNER_ATVBAND_ALL,           /**<Include all three bands*/  /**<CNcomment: 包含上面的三个波段 */
    
    HI_UNF_TUNER_ATVBAND_BUTT,   /**<Invalid value*/                   /**<CNcomment:非法边界值*/
} HI_UNF_TUNER_ATVBAND_E;

/** The frequency range */
/** CNcomment: ATV波段频率范围*/
typedef struct hiUNF_TUNER_ATV_BANDRANGE_S
{        
    HI_U32 u32StartFreq;    /**<Start frequency(KHz)*/      /**<CNcomment:起始频率 KHz*/
    HI_U32 u32EndFreq;      /**<End frequency(KHz)*/        /**<CNcomment:结束频率 KHz*/
} HI_UNF_TUNER_ATV_BANDRANGE_S; 

/** Picture IF type */
/** CNcomment: 图像中频类别*/
typedef enum hiAIF_PIF_E
{  
    HI_AIF_PIF_3340 = 33400,   /**<Picture 33.40Mhz */             /**<CNcomment:图像中频33.40Mhz */ 
    HI_AIF_PIF_3390 = 33900,   /**<Picture 33.90Mhz SECAM-L' */    /**<CNcomment:图像中频33.90Mhz SECAM-L'*/ 
    HI_AIF_PIF_3800 = 38000,   /**<Picture 38.00Mhz PAL*/          /**<CNcomment:图像中频38.00Mhz PAL */
    HI_AIF_PIF_3890 = 38900,   /**<Picture 38.90Mhz PAL */         /**<CNcomment:图像中频38.90Mhz PAL */
    HI_AIF_PIF_4575 = 47570,   /**<Picture 45.75Mhz NTSC-M/N */    /**<CNcomment:图像中频45.75Mhz NTSC-M/N */
    HI_AIF_PIF_5875 = 58750,   /**<Picture 58.75Mhz NTSC-M/N*/     /**<CNcomment:图像中频58.75Mhz NTSC-M/N */
...
/** 
\brief Disconnect the tuner.
CNcomment:\brief 断开TUNER设备。CNend 
\param[in] u32tunerId   tuner port ID. The port ID can be 0-4.         CNcomment: TUNER端口号，取值为0-4 CNend
\retval ::HI_SUCCESS Success                                           CNcomment: 成功 CNend
\retval ::HI_FAILURE Calling this API fails.                           CNcomment: API系统调用失败 CNend
\retval ::HI_ERR_TUNER_NOT_OPEN  The TUNER module is not opened.       CNcomment: 模块没有打开CNend
\retval ::HI_ERR_TUNER_NOT_INIT  The TUNER module is not initialized.  CNcomment: 模块没有初始化CNend
\retval ::HI_ERR_TUNER_INVALID_PORT  The input parameter is invalid.   CNcomment: 输入 参数非法 CNend
\retval ::HI_ERR_TUNER_FAILED_INIT Disconnect The TUNER module fails.  CNcomment: 断开设备失败CNend
\see \n
N/A
*/
HI_S32 HI_UNF_TUNER_DisConnect(HI_U32  u32tunerId);
...
/**
\brief puts the selected SaTCR device into low-power mode
CNcomment: 将unicable设置为低功耗模式。CNend
\attention \n
N/A
\param[in]  u32TunerId    Tuner port ID. The port ID can be 0-2.             CNcomment:TUNER端口号，取值为0-2 CNend
...
N/A
*/
HI_S32 HI_UNF_TUNER_SetStep(HI_U32 u32TunerId, HI_UNF_TUNER_STEP_E enStep);
...
N/A
*/
HI_S32 HI_UNF_TUNER_GetStep(HI_U32 u32TunerId, HI_UNF_TUNER_STEP_E *penStep);
...
N/A
*/
HI_S32 HI_UNF_TUNER_GetBand(HI_U32 u32TunerId,HI_U32 u32Frequency, HI_UNF_TUNER_ATVBAND_E *penBand);

/**
\brief Fine tune the tuner frequency
CNcomment: 微调tuner频点，微调频点场景使用。CNend
\attention \n
N/A
\param[in]  u32TunerId    Tuner port ID. The port ID can be 0-2.             CNcomment:TUNER端口号，取值为0-2 CNend
\param[in]  s8Step        Fine tune step,suggest [-1, 1].                    CNcomment:微调步长，建议[-1, 1] CNend
\retval ::HI_SUCCESS   Success                                               CNcomment:成功 CNend
\retval ::HI_FAILURE   Calling this API fails.                               CNcomment:API系统调用失败 CNend
\see \n
N/A
*/
HI_S32 HI_UNF_TUNER_SetFineTune(HI_U32 u32TunerId, HI_S8 s8Step);
...
N/A
\param[in]  u32TunerId    Tuner port ID. The port ID can be 0-2.             CNcomment:TUNER端口号，取值为0-2 CNend
\param[in]  enBand        Frequency band.                                    CNcomment:频段 CNend
\param[in]  pstBandRange  Frequency range.                                   CNcomment:频率范围 CNend
\retval ::HI_SUCCESS   Success                                               CNcomment:成功 CNend
\retval ::HI_FAILURE   Calling this API fails.                               CNcomment:API系统调用失败 CNend
\see \n
N/A
*/
HI_S32 HI_UNF_TUNER_GetBandRange(HI_U32 u32TunerId, HI_UNF_TUNER_ATVBAND_E enBand, HI_UNF_TUNER_ATV_BANDRANGE_S *pstBandRange);
...
N/A
\param[in]  u32TunerId    Tuner port ID. The port ID can be 0-2.             CNcomment:TUNER端口号，取值为0-2 CNend
\param[in]  u32Top        TOP information.                                   CNcomment:TOP信息 CNend
\retval ::HI_SUCCESS   Success                                               CNcomment:成功 CNend
\retval ::HI_FAILURE   Calling this API fails.                               CNcomment:API系统调用失败 CNend
\see \n
N/A
*/
HI_S32 HI_UNF_TUNER_SetTopAdjustment(HI_U32 u32TunerId,HI_U32 u32Top);
...
N/A
\param[in]  u32TunerId    Tuner port ID. The port ID can be 0-2.             CNcomment:TUNER端口号，取值为0-2 CNend
\param[out] pu32BitRate   bit rate.                                          CNcomment:比特率 CNend
\retval ::HI_SUCCESS   Success                                               CNcomment:成功 CNend
\retval ::HI_FAILURE   Calling this API fails.                               CNcomment:API系统调用失败 CNend
\see \n
N/A
*/
HI_S32 HI_UNF_TUNER_GetBitRate(HI_U32 u32TunerId, HI_U32 *pu32BitRate);
