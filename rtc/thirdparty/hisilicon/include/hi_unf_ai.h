...
typedef enum hiHI_UNF_AI_HDMI_DATA_TYPE_E
{
    HI_UNF_AI_HDMI_DATA_PCM = 0,
    HI_UNF_AI_HDMI_DATA_DD = 1,
    HI_UNF_AI_HDMI_DATA_DDP = 2,
    HI_UNF_AI_HDMI_DATA_DTS = 3,
    HI_UNF_AI_HDMI_DATA_DTSHD = 4,
    HI_UNF_AI_HDMI_DATA_TRUEHD = 5,
    HI_UNF_AI_HDMI_DATA_UNKNOWN = 6,
    HI_UNF_AI_HDMI_DATA_BUTT
} HI_UNF_AI_HDMI_DATA_TYPE_E;
...
typedef struct hiUNF_AI_HDMI_ATTR_S
{
    ...
    HI_UNF_AI_HDMI_DATA_TYPE_E enHdmiAudioDataType;   /**<HDMI passthrough audio data type*/ /**<CNcomment:HDMI透传数据类型*/
...
/**Defines the type of NR process.*/
/**CNcomment: 定义NR处理类型枚举*/
typedef enum hiHI_UNF_AI_NR_TYPE_E
{
    HI_UNF_AI_NR_OFF = 0,  /**<disnable NR process*/ /**<CNcomment: 关闭NR处理 */
    HI_UNF_AI_NR_NORMAL,   /**<normal NR process*/ /**<CNcomment: 普通的NR处理 */
    HI_UNF_AI_NR_MUTE,     /**<mute noise process*/ /**<CNcomment: 静音底噪处理 */
    HI_UNF_AI_NR_BUTT
} HI_UNF_AI_NR_TYPE_E;


/**Defines NORMAL NR attribute */
/**CNcomment:定义NORMAL NR属性*/
typedef struct hiUNF_AI_NR_NORMAL_ATTR_S
{
    HI_U32 u32Para;
} HI_UNF_AI_NR_NORMAL_ATTR_S;

/**Defines MUTE NR attribute */
/**CNcomment:定义MUTE NR属性*/
typedef struct hiUNF_AI_NR_MUTE_ATTR_S
{
    HI_S32 s32Threshold;     /**<threshold of NR process,range from -100dB to -60dB*/ /**<CNcomment: 底噪处理阈值单位db 范围: -100dB ~ -60dB */
} HI_UNF_AI_NR_MUTE_ATTR_S;

/**Defines  Audio NR attribute */
/**CNcomment:定义音频NR属性*/
typedef struct hiHI_UNF_AI_NR_ATTR_S
{
    HI_UNF_AI_NR_TYPE_E enNRType;  /**<type of NR process*/ /**<CNcomment: NR处理类型 */

    union
    {
        HI_UNF_AI_NR_NORMAL_ATTR_S  stNormalAttr;    /**<NR NORMAL Attribute*/ /**<CNcomment:NR NORMAL属性*/
        HI_UNF_AI_NR_MUTE_ATTR_S  stMuteAttr;    /**<NR MUTE Attribute*/ /**<CNcomment:NR MUTE属性*/
    } unNRAttr;
} HI_UNF_AI_NR_ATTR_S;
...
/**
\brief get stream encode type. CNcomment: 获取码流编码类型 CNend
\attention \n
\param[in] AI handle CNcomment: AI句柄 CNend
\param[out] penStreamType    stream encode type.CNcomment:码流编码类型 CNend
\retval ::HI_SUCCESS CNcomment: success.成功 CNend
\retval ::HI_ERR_AI_NULL_PTR          Input pointer is NULL.CNcomment:输入指针为空 CNend
\retval ::HI_ERR_AI_INVALID_ID     The handle is invalid. CNcomment: 非法句柄 CNend
\see \n
N/A CNcomment: 无 CNend
*/
HI_S32 HI_UNF_AI_GetStreamType(HI_HANDLE hAI, HI_UNF_AI_HDMI_DATA_TYPE_E *penStreamType);

/**
\brief set NR attribute. CNcomment: 设置NR属性 CNend
\attention \n
\param[in] hAi AI handle CNcomment: AI句柄 CNend
\param[in] pstNRAttr  Pointer to NR attributes CNcomment: NR属性指针 CNend
\retval ::HI_SUCCESS Success CNcomment: 成功 CNend
\retval ::HI_ERR_AI_NULL_PTR   The pointer is null. CNcomment: 空指针 CNend
\retval ::HI_ERR_AI_INVALID_ID   The handle is invalid. CNcomment: 非法句柄 CNend
\retval ::HI_ERR_AI_INVALID_PARA   The attribute parameters are incorrect. CNcomment: 属性参数错误 CNend
...
N/A CNcomment: 无 CNend
*/
HI_S32 HI_UNF_AI_SetNRAttr(HI_HANDLE hAI, const HI_UNF_AI_NR_ATTR_S *pstNRAttr);


/**
 \brief Obtains the attributes of a NR. CNcomment: 获取NR属性 CNend
 \attention \n
 \param[in] hAi AI handle CNcomment: AI句柄 CNend
 \param[out] pstNRAttr Pointer to NR attributes CNcomment: NR属性指针 CNend
 \retval ::HI_SUCCESS Success CNcomment: 成功 CNend
 \retval ::HI_ERR_AI_NULL_PTR   The pointer is null. CNcomment: 空指针 CNend
 \retval ::HI_ERR_AI_INVALID_ID   The handle is invalid. CNcomment: 非法句柄 CNend
 \retval ::HI_ERR_AI_INVALID_PARA   The handle is incorrect. CNcomment: 句柄错误 CNend
...
N/A CNcomment: 无 CNend
 */
HI_S32 HI_UNF_AI_GetNRAttr(HI_HANDLE hAI, HI_UNF_AI_NR_ATTR_S *pstNRAttr);
