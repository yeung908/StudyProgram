...
/**ARC MODE:LPCM,RAW,HBR2LBR,AUTO*/
/**CNcomment:ARC 模式设置:LPCM,RAW,HBR2LBR,AUTO*/
typedef enum hiHI_UNF_SND_ARC_AUDIO_MODE_E
{
    HI_UNF_SND_ARC_AUDIO_MODE_LPCM,     /**<ARC LCPM2.0*/ /**<CNcomment: 立体声pcm*/
    HI_UNF_SND_ARC_AUDIO_MODE_RAW,      /**<ARC Pass-through.*/ /**<CNcomment: ARC透传*/
    HI_UNF_SND_ARC_AUDIO_MODE_HBR2LBR,  /**<ARC Pass-through force high-bitrate transcoding to low-bitrate. DD+ transcoded to DD*/ /**<CNcomment: ARC降规格透传输出，DDP转化为DD*/
    HI_UNF_SND_ARC_AUDIO_MODE_AUTO,     /**<automatically match according to the audio capbility of ARC from HDMIRX*/ /**<CNcomment: 根据从HDMIRX获取到的ARC音频能力自动匹配输出*/
    HI_UNF_SND_ARC_AUDIO_MODE_BUTT
} HI_UNF_SND_ARC_AUDIO_MODE_E;

/** @} */  /** <!-- ==== Structure Definition end ==== */
/**ARC audio Capbilities*/
/**CNcomment:ARC 音频能力*/
typedef struct hiHI_UNF_SND_ARC_AUDIO_CAP_S
{
...
typedef enum
{
    ...
    HI_UNF_SND_AEF_TYPE_SPECTRUM   = 0x120, /**<SPECTRUM */ /**<CNcomment: SPECTRUM组件*/
} HI_UNF_SND_AEF_TYPE_E;

/**Defines  tracks onAudio Sound device attribute */
/**CNcomment:定义Sound设备track信息*/
typedef struct hiHI_UNF_SND_TRACK_INFO_S
{
    HI_U32               u32TrackNum;  /**<track number*/ /**<CNcomment:绑定到Sound设备的track数量*/
    HI_HANDLE            hTrack[HI_UNF_SND_TRACK_MAX];  /**<track attached sound*/ /**<CNcomment:绑定到Sound设备的输出端口*/
} HI_UNF_SND_TRACK_INFO_S;
...
typedef struct hiHI_UNF_SND_PEQ_BAND_ATTR_S
{
    ...
    HI_U32 u32freq;  /**<center frequency of the band, HP and LS[20, 4000], PK[20, 22000], HS and LP[4000, 22000]*/
                     /**<CNcomment: 某一频带的中心频率,范围: HP and LS[20, 4000], PK[20, 22000], HS and LP[4000, 22000] */
...
/**CNcomment:GEQ 频带属性 */
typedef struct hiHI_UNF_SND_GEQ_BAND_ATTR_S
{
    HI_U32 u32freq;  /**<center frequency of the band*/ /**<CNcomment: 某一频带的中心频率*/
    HI_S32 s32Gain; /**<gain of the band, if -2.125, value is -2125,Gain ranging from -15 to 15 step by 0.125dB*/
                    /**<CNcomment: 某一频带的增益,如值为-2.125,设置值为-2125, 范围为-15至15 */
} HI_UNF_SND_GEQ_BAND_ATTR_S;

/**Defines  GEQ attribute */
/**CNcomment:GEQ属性 */
typedef struct hiHI_UNF_SND_GEQ_ATTR_S
{
    HI_U32 u32BandNum; /**<the GEQ band number, ranging from 5 to 10*/ /**<CNcomment: GEQ频带数量,范围为5至10*/
    HI_UNF_SND_GEQ_BAND_ATTR_S stEqParam[HI_UNF_SND_EQ_BANDNUM_MAX];/**<GEQ band attribute*/ /**<CNcomment: GEQ频带属性*/
} HI_UNF_SND_GEQ_ATTR_S;
...
typedef struct hiHI_UNF_SND_DRC_ATTR_S
{
    ...
    HI_S32  s32Thrhd;  /**<the threshold value(unit:dB),ranging from -80 to -1*/ /**<CNcomment: 开始限幅幅值(单位:dB),范围:[-80, -1)*/
     HI_S32 s32Limit;  /**<the maximum value(unit:dB),ranging from -80 to -1*/ /**<CNcomment: 最大限幅幅值(单位:dB),范围:(-80, -1]*/
...
typedef enum
{
    HI_UNF_SND_SOURCE_ALSA = 0,
    HI_UNF_SND_SOURCE_ATV,
    HI_UNF_SND_SOURCE_AV,
    HI_UNF_SND_SOURCE_VGA,
    HI_UNF_SND_SOURCE_YPBPR,
    HI_UNF_SND_SOURCE_HDMI,
    HI_UNF_SND_SOURCE_DTV,
    HI_UNF_SND_SOURCE_MEDIA,
    HI_UNF_SND_SOURCE_SCART,

    HI_UNF_SND_SOURCE_BUTT,
}HI_UNF_SND_SOURCE_E;

/**Track config of sources*/
/**CNcomment:保存各源下Track的配置*/
typedef struct hiHI_UNF_SND_TRACK_CONFIG_S
{
    HI_UNF_SND_PRECIGAIN_ATTR_S  stTrackPrescale[HI_UNF_SND_SOURCE_BUTT];  /**<track prescale of sources*/ /**<CNcomment:各源下Track的prescale*/
} HI_UNF_SND_TRACK_CONFIG_S;
...
/**
\brief Obtains the track information on sound. CNcomment:获取音频设备上的Track信息 CNend
\attention \n
N/A
\param[in] enSound     ID of an AO device CNcomment:音频输出设备号 CNend
\param[out] pstTrackInfo   Pointer to the AO track information.
CNcomment:指针类型，音频Track信息. CNend
\retval ::HI_SUCCESS Success CNcomment:成功 CNend
\retval ::HI_ERR_AO_SOUND_NOT_OPEN    Sound device is not opened. CNcomment:Sound设备未打开 CNend
\retval ::HI_ERR_AO_NULL_PTR           The pointer is null. CNcomment:指针参数为空 CNend
\retval ::HI_ERR_AO_INVALID_PARA    The parameter is invalid. CNcomment:无效的参数 CNend
...
N/A
*/
HI_S32 HI_UNF_SND_GetTrackInfo(HI_UNF_SND_E enSound, HI_UNF_SND_TRACK_INFO_S *pstTrackInfo);
...
/**
\brief Set source of track. CNcomment: 设置track的源 CNend
\attention \n
1.Except alsa.
2.AO driver sets track config including prescale according to the source setted.
CNcomment:1.Alsa 不可设
2.AO驱动会根据所设源设置track对应的包括prescale在内的配置CNend
\param[in] hTrack   Track handle CNcomment:Track 句柄 CNend
\param[in] enSource  Source of track.     CNcomment:track所属的源 CNend
\retval ::HI_SUCCESS  success. CNcomment: 成功 CNend
\retval ::HI_ERR_AO_SOUND_NOT_OPEN    Sound device is not opened. CNcomment:Sound设备未打开 CNend
...
none.CNcomment:无 CNend
*/
HI_S32 HI_UNF_SND_SetTrackSource(HI_HANDLE hTrack, HI_UNF_SND_SOURCE_E enSource);

/**
\brief Init track config of all sources. CNcomment: 初始化各源下Track的配置 CNend
\attention \n
none. CNcomment:无 CNend
\param[in] enSound    ID of an AO device CNcomment:音频输出设备号 CNend
\param[in] pstTrackConfig  Track config   CNcomment:各源下Track的配置 CNend
\retval ::HI_SUCCESS  success. CNcomment: 成功 CNend
\retval ::HI_ERR_AO_SOUND_NOT_OPEN    Sound device is not opened. CNcomment:Sound设备未打开 CNend
\retval ::HI_ERR_AO_INVALID_PARA      invalid input parameter.CNcomment:输入参数非法 CNend
\retval ::HI_ERR_AO_NULL_PTR           The pointer is null. CNcomment:指针参数为空 CNend
...
none.CNcomment:无 CNend
*/
HI_S32 HI_UNF_SND_TrackConfigInit(HI_UNF_SND_E enSound, const HI_UNF_SND_TRACK_CONFIG_S* pstTrackConfig);
...
/**
\brief Obtains the prescale of alsa track. CNcomment:获得Alsa Track的预增益 CNend
\attention \n
\param[in] enSound        ID of an AO device CNcomment:音频输出设备号 CNend
\param[out] pstPreciGain        Pointer to the prescale CNcomment:指针类型，预增益属性 CNend
\retval ::HI_SUCCESS Success CNcomment:成功 CNend
...
N/A
*/
HI_S32 HI_UNF_SND_SetAlsaPrescale(HI_UNF_SND_E enSound, HI_UNF_SND_PRECIGAIN_ATTR_S *pstPreciGain);
...
/**
\brief Sets ARC Enable. CNcomment:设置ARC使能 CNend
\attention \n
none. CNcomment:无 CNend
\param[in] enSound        ID of an AO device CNcomment:音频输出设备号 CNend
\param[in] enOutPort  Audio OutputPort     CNcomment:音频输出端口 CNend
\param[in] bEnable     Enbale or disable CNcomment:使能与否 CNend
\retval ::HI_SUCCESS Success CNcomment:成功 CNend
\retval ::HI_FAILURE FAILURE CNcomment:失败 CNend
\retval ::HI_ERR_AO_SOUND_NOT_OPEN    Sound device is not opened. CNcomment:Sound设备未打开 CNend
\retval ::HI_ERR_AO_INVALID_PARA     The parameter is invalid. CNcomment:无效的参数 CNend
...
N/A
*/
HI_S32 HI_UNF_SND_SetArcEnable(HI_UNF_SND_E enSound, HI_UNF_SND_OUTPUTPORT_E enOutPort, HI_BOOL bEnable);

/**
\brief Obtains ARC enable status. CNcomment:获取ARC的使能状态 CNend
\attention \n
none. CNcomment:无 CNend
\param[in] enSound         ID of an AO device CNcomment:音频输出设备号 CNend
\param[in] enOutPort  Audio OutputPort     CNcomment:音频输出端口 CNend
\param[out] pbEnable   Pointer to the obtained ARC enable status CNcomment:指针类型，获取到的使能状态 CNend
\retval ::HI_SUCCESS Success CNcomment:成功 CNend
\retval ::HI_FAILURE FAILURE CNcomment:失败 CNend
\retval ::HI_ERR_AO_SOUND_NOT_OPEN    Sound device is not opened. CNcomment:Sound设备未打开 CNend
\retval ::HI_ERR_AO_INVALID_PARA     The parameter is invalid. CNcomment:无效的参数 CNend
...
N/A
*/
HI_S32 HI_UNF_SND_GetArcEnable(HI_UNF_SND_E enSound, HI_UNF_SND_OUTPUTPORT_E enOutPort, HI_BOOL *pbEnable);

/**
\brief Sets ARC mode type. CNcomment:设置ARC模式类型 CNend
\attention \n
none. CNcomment:无 CNend
\param[in] enSound        ID of an AO device CNcomment:音频输出设备号 CNend
\param[in] enOutPort  Audio OutputPort     CNcomment:音频输出端口 CNend
\param[in] enArcMode     ARC mode type CNcomment:ARC模式类型 CNend
\retval ::HI_SUCCESS Success CNcomment:成功 CNend
\retval ::HI_FAILURE FAILURE CNcomment:失败 CNend
\retval ::HI_ERR_AO_SOUND_NOT_OPEN    Sound device is not opened. CNcomment:Sound设备未打开 CNend
\retval ::HI_ERR_AO_INVALID_PARA     The parameter is invalid. CNcomment:无效的参数 CNend
...
N/A
*/
HI_S32 HI_UNF_SND_SetArcMode(HI_UNF_SND_E enSound, HI_UNF_SND_OUTPUTPORT_E enOutPort, HI_UNF_SND_ARC_AUDIO_MODE_E enArcMode);

/**
\brief Obtains ARC mode type. CNcomment:获取ARC的模式类型 CNend
\attention \n
none. CNcomment:无 CNend
\param[in] enSound         ID of an AO device CNcomment:音频输出设备号 CNend
\param[in] enOutPort  Audio OutputPort     CNcomment:音频输出端口 CNend
\param[out] penArcMode   Pointer to the obtained ARC mode type CNcomment:指针类型，获取到的模式类型 CNend
\retval ::HI_SUCCESS Success CNcomment:成功 CNend
\retval ::HI_FAILURE FAILURE CNcomment:失败 CNend
\retval ::HI_ERR_AO_SOUND_NOT_OPEN    Sound device is not opened. CNcomment:Sound设备未打开 CNend
\retval ::HI_ERR_AO_INVALID_PARA     The parameter is invalid. CNcomment:无效的参数 CNend
...
N/A
*/
HI_S32 HI_UNF_SND_GetArcMode(HI_UNF_SND_E enSound, HI_UNF_SND_OUTPUTPORT_E enOutPort, HI_UNF_SND_ARC_AUDIO_MODE_E *penArcMode);

/**
\brief Sets ARC audio capbility. CNcomment:设置ARC音频能力 CNend
\attention \n
none. CNcomment:无 CNend
\param[in] enSound        ID of an AO device CNcomment:音频输出设备号 CNend
\param[in] enOutPort  Audio OutputPort     CNcomment:音频输出端口 CNend
\param[in] pstArcCap   Pointer to ARC audio capbility CNcomment:指针类型，ARC音频能力 CNend
\retval ::HI_SUCCESS Success CNcomment:成功 CNend
\retval ::HI_FAILURE FAILURE CNcomment:失败 CNend
\retval ::HI_ERR_AO_SOUND_NOT_OPEN    Sound device is not opened. CNcomment:Sound设备未打开 CNend
\retval ::HI_ERR_AO_INVALID_PARA     The parameter is invalid. CNcomment:无效的参数 CNend
...
N/A
*/
HI_S32 HI_UNF_SND_SetArcCap(HI_UNF_SND_E enSound, HI_UNF_SND_OUTPUTPORT_E enOutPort, HI_UNF_SND_ARC_AUDIO_CAP_S *pstArcCap);

/**
\brief Obtains ARC audio capbility. CNcomment:获取ARC的音频能力 CNend
\attention \n
none. CNcomment:无 CNend
\param[in] enSound         ID of an AO device CNcomment:音频输出设备号 CNend
\param[in] enOutPort  Audio OutputPort     CNcomment:音频输出端口 CNend
\param[out] pstArcCap   Pointer to the obtained ARC audio capbility CNcomment:指针类型，获取到的音频能力 CNend
\retval ::HI_SUCCESS Success CNcomment:成功 CNend
\retval ::HI_FAILURE FAILURE CNcomment:失败 CNend
\retval ::HI_ERR_AO_SOUND_NOT_OPEN    Sound device is not opened. CNcomment:Sound设备未打开 CNend
\retval ::HI_ERR_AO_INVALID_PARA     The parameter is invalid. CNcomment:无效的参数 CNend
...
N/A
*/
HI_S32 HI_UNF_SND_GetArcCap(HI_UNF_SND_E enSound, HI_UNF_SND_OUTPUTPORT_E enOutPort, HI_UNF_SND_ARC_AUDIO_CAP_S *pstArcCap);

/**
\brief Sets the mute status of audio cast. CNcomment:设置所有音频Cast静音状态 CNend
\attention \n
N/A
\param[in] enSound   All cast of the sound CNcomment:此Sound的全部Cast CNend
\param[in] bMute
\retval ::HI_SUCCESS Success CNcomment:成功 CNend
\retval ::HI_FAILURE FAILURE CNcomment:失败 CNend
\retval ::HI_ERR_AO_SOUND_NOT_OPEN    Sound device is not opened. CNcomment:Sound设备未打开 CNend
...
N/A
*/
HI_S32  HI_UNF_SND_SetAllCastMute(HI_UNF_SND_E enSound, HI_BOOL bMute);

/**
\brief Obtains the mute status of audio cast. CNcomment:获取所有音频Cast的静音状态 CNend
\attention \n
N/A
\param[in] enSound   All cast of the sound CNcomment:此Sound的全部Cast CNend
\param[out] pbMute
...
N/A
*/
HI_S32  HI_UNF_SND_GetAllCastMute(HI_UNF_SND_E enSound, HI_BOOL *pbMute);
...
/**
\brief Get start/stop status of audio effect postprocess. CNcomment: 获取音效处理的启动/停止状态 CNend
\attention \n
none. CNcomment:无 CNend
\param[in] phAef   audio effect handle .CNcomment:音效句柄 CNend
\param[out] pbEnable start/stop status .CNcomment:音效启动/停止状态指针 CNend
\retval ::HI_SUCCESS  success. CNcomment: 成功 CNend
\retval ::HI_ERR_AO_SOUND_NOT_OPEN    Sound device is not opened. CNcomment:Sound设备未打开 CNend
\retval ::HI_ERR_AO_INVALID_PARA      invalid input parameter.CNcomment:输入参数非法 CNend
\see \n
none.CNcomment:无 CNend
*/
HI_S32 HI_UNF_SND_GetAefEnable(HI_HANDLE hAef, HI_BOOL *pbEnable);
...
none.CNcomment:无 CNend
*/
HI_S32 HI_UNF_SND_SetPeqAttr(HI_UNF_SND_E enSound, const HI_UNF_SND_PEQ_ATTR_S *pstPeqAttr);
...
N/A
*/
HI_S32 HI_UNF_SND_GetPeqAttr(HI_UNF_SND_E enSound, HI_UNF_SND_PEQ_ATTR_S *pstPeqAttr);
...
none.CNcomment:无 CNend
*/
HI_S32 HI_UNF_SND_SetPeqEnable(HI_UNF_SND_E enSound, HI_BOOL bEnable);
...
none.CNcomment:无 CNend
*/
HI_S32 HI_UNF_SND_GetPeqEnable(HI_UNF_SND_E enSound, HI_BOOL *pbEnable);

/**
\brief Set audio geq attr. CNcomment: 设置geq属性 CNend
\attention \n
none. CNcomment:无 CNend
\param[in] enSound    ID of an AO device CNcomment:音频输出设备号 CNend
\param[in] pstGeqAttr  the attribute of the geq .CNcomment:geq属性 CNend
\retval ::HI_SUCCESS   success. CNcomment: 成功 CNend
\retval ::HI_ERR_AO_SOUND_NOT_OPEN    Sound device is not opened. CNcomment:Sound设备未打开 CNend
\retval ::HI_ERR_AO_INVALID_PARA The parameter is invalid. CNcomment:无效的参数 CNend
\retval ::HI_ERR_AO_NULL_PTR           The pointer is null. CNcomment:指针参数为空 CNend
...
none.CNcomment:无 CNend
*/
HI_S32 HI_UNF_SND_SetGeqAttr(HI_UNF_SND_E enSound, const HI_UNF_SND_GEQ_ATTR_S *pstGeqAttr);

/**
\brief get the attribute of  geq, reversed. CNcomment:获取geq的属性，预留 CNend
\attention \n
none. CNcomment:无 CNend
\param[in] enSound    ID of an AO device CNcomment:音频输出设备号 CNend
\param[out] pstGeqAttr   the attribute of geq CNcomment:peq 属性 CNend
\retval ::HI_SUCCESS Success CNcomment:成功 CNend
\retval ::HI_ERR_AO_SOUND_NOT_OPEN    Sound device is not opened. CNcomment:Sound设备未打开 CNend
\retval ::HI_ERR_AO_NULL_PTR           The pointer is null. CNcomment:指针参数为空 CNend
\see \n
N/A
*/
HI_S32 HI_UNF_SND_GetGeqAttr(HI_UNF_SND_E enSound, HI_UNF_SND_GEQ_ATTR_S *pstGeqAttr);

/**
\brief start/stop geq process. CNcomment: 启动/停止geq处理功能 CNend
\attention \n
none. CNcomment:无
\param[in] enSound    ID of an AO device CNcomment:音频输出设备号 CNend
\param[in] bEnable    start/stop .CNcomment: 启动/停止 CNend
...
none.CNcomment:无 CNend
*/
HI_S32 HI_UNF_SND_SetGeqEnable(HI_UNF_SND_E enSound, HI_BOOL bEnable);

/**
\brief Get start/stop status of geq postprocess. CNcomment: 获取geq处理的启动/停止状态 CNend
\attention \n
none. CNcomment:无 CNend
\param[in] enSound    ID of an AO device CNcomment:音频输出设备号 CNend
\param[out] pbEnable start/stop status .CNcomment:peq启动/停止状态指针 CNend
...
none.CNcomment:无 CNend
*/
HI_S32 HI_UNF_SND_GetGeqEnable(HI_UNF_SND_E enSound, HI_BOOL *pbEnable);

/**
\brief set geq band gain. CNcomment: 设置geq某一频段增益 CNend
\attention \n
none. CNcomment:无
\param[in] enSound    ID of an AO device CNcomment:音频输出设备号 CNend
\param[in] u32Band    the band order .CNcomment: 频段序列 CNend
\param[in] s32Gain    the band gain  .CNcomment: 频段增益 CNend
\retval ::HI_SUCCESS CNcomment: success.成功 CNend
\retval ::HI_ERR_AO_SOUND_NOT_OPEN    Sound device is not opened. CNcomment:Sound设备未打开 CNend
\retval ::HI_ERR_AO_INVALID_PARA   invalid input parameter.CNcomment:输入参数非法 CNend
\see \n
none.CNcomment:无 CNend
*/
HI_S32 HI_UNF_SND_SetGeqGain(HI_UNF_SND_E enSound, HI_U32 u32Band, HI_S32 s32Gain);

/**
\brief get geq band gain. CNcomment: 获取geq某一频段增益 CNend
\attention \n
none. CNcomment:无
\param[in] enSound    ID of an AO device CNcomment:音频输出设备号 CNend
\param[in] u32Band    the band order .CNcomment: 频段序列 CNend
\param[in] ps32Gain    Pointer to the band gain  .CNcomment: 频段增益指针 CNend
\retval ::HI_SUCCESS CNcomment: success.成功 CNend
\retval ::HI_ERR_AO_SOUND_NOT_OPEN    Sound device is not opened. CNcomment:Sound设备未打开 CNend
\retval ::HI_ERR_AO_INVALID_PARA   invalid input parameter.CNcomment:输入参数非法 CNend
\retval ::HI_ERR_AO_NULL_PTR        The pointer is null. CNcomment:指针参数为空 CNend
...
none.CNcomment:无 CNend
*/
HI_S32 HI_UNF_SND_GetGeqGain(HI_UNF_SND_E enSound, HI_U32 u32Band, HI_S32 *ps32Gain);
