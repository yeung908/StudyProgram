...
typedef struct hiUNF_AVPLAY_3D_DETECT_ATTR_S
{
    HI_BOOL               bEnable;  /**<Is 3d detect enable or not*//**<CNcomment: 3d格式检测是否使能*/
}HI_UNF_AVPLAY_3D_DETECT_ATTR_S;
...
typedef enum hiUNF_AVPLAY_INVOKE_E
{
    ...
    HI_UNF_AVPLAY_INVOKE_SET_WIN_OWNER,  /**<Invoke commond to set window owner*//**<CNcomment: 设置Window 创建者*/
...
\retval ::HI_FAILURE  Failure, no AVPLAY attached to the window. CNcomment:失败,没有AVPLAY邦定到窗口. CNend
\see \n
N/A
*/
HI_S32 HI_UNF_AVPLAY_GetHandleByWindow(HI_HANDLE hWindow, HI_HANDLE *phAvplay);
...
/**
\brief Set 3D detect attribute. CNcomment:设置3D检测属性 CNend
\attention \n
\param[in] pst3dDetectAttr  Pointer 3D detect attribute. For details, see the description of ::HI_UNF_AVPLAY_3D_DETECT_ATTR_S. CNcomment:指针类型，3D检测属性，请参见::HI_UNF_AVPLAY_3D_DETECT_ATTR_S. CNend
\param[in] hAvplay    AVPLAY handle . CNcomment:AVPLAY句柄 . CNend
\retval ::HI_SUCCESS Success CNcomment:成功 CNend
\retval ::HI_ERR_AVPLAY_NULL_PTR  The pointer is null.  CNcomment:指针为空 CNend
\retval ::HI_ERR_AVPLAY_INVALID_PARA     The input parameter is invalid. CNcomment:输入参数非法 CNend
...
N/A
*/
HI_S32 HI_UNF_AVPLAY_Set3DDetect(HI_HANDLE hAvplay, HI_UNF_AVPLAY_3D_DETECT_ATTR_S *pst3dDetectAttr);

/**
\brief Get Result of 3D detect. CNcomment:获取3D检测结果 CNend
\attention \n
\param[out] pst3dFormat  Pointer 3D detect result. For details, see the description of ::HI_UNF_VIDEO_FRAME_PACKING_TYPE_E. CNcomment:指针类型，3D检测结果，请参见::HI_UNF_VIDEO_FRAME_PACKING_TYPE_E. CNend
\param[in] hAvplay    AVPLAY handle . CNcomment:AVPLAY句柄 . CNend
\retval ::HI_SUCCESS Success CNcomment:成功 CNend
\retval ::HI_ERR_AVPLAY_NULL_PTR  The pointer is null.  CNcomment:指针为空 CNend
\retval ::HI_ERR_AVPLAY_INVALID_PARA     The input parameter is invalid. CNcomment:输入参数非法 CNend
...
N/A
*/
HI_S32 HI_UNF_AVPLAY_Get3DResult(HI_HANDLE hAvplay, HI_UNF_VIDEO_FRAME_PACKING_TYPE_E *pst3dFormat);
...
\attention \n
support Closed Caption Data,Active Format Description,DVB1_bar.
CNcomment: 支持CC、AFD、BAR数据 CNend
\param[in] hAvplay       AVPLAY handle CNcomment: AV播放句柄 CNend
...
HI_S32 HI_UNF_AVPLAY_AcqUserDataExt(HI_HANDLE hAvplay, HI_UNF_VIDEO_USERDATA_TYPE_E enType,HI_UNF_VIDEO_USERDATA_S *pstUserData);
/**
\brief Extended interface for Release user dada. CNcomment: 释放用户数据的扩展接口 CNend
\attention \n
Only support Closed Caption Data,Active Format Description,DVB1_bar..
CNcomment: 仅支持CC、AFD、BAR数据 CNend
\param[in] hAvplay       AVPLAY handle CNcomment: AV播放句柄 CNend
\param[in] enType      user data type. CNcomment:用户数据类型 CNend
\param[in] pstUserData  user data.CNcomment:用户数据 CNend
...
HI_S32 HI_UNF_AVPLAY_RlsUserDataExt(HI_HANDLE hAvplay, HI_UNF_VIDEO_USERDATA_TYPE_E enType,HI_UNF_VIDEO_USERDATA_S *pstUserData);
