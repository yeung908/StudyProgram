...
typedef struct hiDMX_GetDataFlag_S
{
    ...
    HI_U32 *ValidChannelNum;      /* channel has data number */
    HI_U32 u32TimeOutMs;
}DMX_GetDataFlag_S;
...
typedef struct hiDMX_SelectDataFlag_S
{
    HI_VIRT_ADDR_T channelsAddr;             /*channel handles to check*/
    HI_U32 channelnum;              /*channel number to check*/
...
{
    HI_HANDLE               RecHandle;
    HI_DRV_DMX_REC_DATA_INDEX_S  RecDataIdx;
