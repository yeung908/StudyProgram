...
{
    HI_BOOL    bDeepColorY444   ;         /**<the Deep Color support YCBCR444 or not*//**<CNcomment:是否支持 YCBCR 4:4:4  Deep Color 模式 */
    HI_BOOL    bDeepColor30Bit  ;         /**<the Deep Color support 30 bit  or not *//**<CNcomment:是否支持Deep Color 30bit 模式 */
    HI_BOOL    bDeepColor36Bit  ;         /**<the Deep Color support 36 bit  or not *//**<CNcomment:是否支持Deep Color 36bit 模式 */
    HI_BOOL    bDeepColor48Bit  ;         /**<the Deep Color support 48 bit  or not *//**<CNcomment:是否支持Deep Color 48bit 模式 */
...
typedef struct hiUNF_EDID_BASE_INFO_S
{
    ...
    HI_UNF_EDID_DEEP_COLOR_S        stDeepColor;            /**<deep color Info*//**<CNcomment:3d 能力集 */
    HI_UNF_EDID_COLORIMETRY_S       stColorMetry;           /**<colorimetry Info*//**<CNcomment:3d 能力集 */
    HI_UNF_EDID_COLOR_SPACE_S       stColorSpace;           /**<color space Info*//**<CNcomment:3d 能力集 */            
    
    HI_UNF_EDID_AUDIO_INFO_S        stAudioInfo[HI_UNF_EDID_MAX_AUDIO_CAP_COUNT];   /**<audio Info*//**<CNcomment:3d 能力集 */
    HI_U32                          u32AudioInfoNum;                                /**<num of audio Info*//**<CNcomment:3d 能力集 */
    HI_BOOL                         bSupportAudioSpeaker[HI_UNF_EDID_AUDIO_SPEAKER_BUTT];/**<speaker Info*//**<CNcomment:3d 能力集 */
