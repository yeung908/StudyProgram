...
/*AO SND command code*/
 ...
 /*ARC Ioctl*/
 #define CMD_AO_SND_SETARCENABLE _IOW  (HI_ID_AO, 0x3a, AO_SND_ARC_ENABLE_Param_S)
 #define CMD_AO_SND_GETARCENABLE _IOWR  (HI_ID_AO, 0x3b, AO_SND_ARC_ENABLE_Param_S)
 #define CMD_AO_SND_SETARCMODE _IOW  (HI_ID_AO, 0x3c, AO_SND_ARC_MODE_Param_S)
 #define CMD_AO_SND_GETARCMODE _IOWR  (HI_ID_AO, 0x3d, AO_SND_ARC_MODE_Param_S)
 #define CMD_AO_SND_SETARCCAP _IOW  (HI_ID_AO, 0x3e, AO_SND_ARC_CAP_Param_S)
 #define CMD_AO_SND_GETARCCAP _IOWR  (HI_ID_AO, 0x3f, AO_SND_ARC_CAP_Param_S)
...
/*AO Cast command code*/
 ...
 #define CMD_AO_TRACK_MMAPTRACKATTR _IOWR  (HI_ID_AO, 0x74, AO_Track_GetTrackMapInfo_Param_S)
 ...
 #define CMD_AO_SND_TRACKCONFIGINIT _IOW  (HI_ID_AO, 0x77, AO_SND_TrackConfig_Param_S)
#ifdef __cplusplus
#if __cplusplus
}
#endif
