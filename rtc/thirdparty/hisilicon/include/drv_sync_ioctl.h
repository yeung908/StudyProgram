...
typedef enum tagSYNC_EXT_INFO_E
{
    ...
    SYNC_EXT_INFO_STOP_REGION,   /*HI_BOOL*/
    SYNC_EXT_INFO_AUD_STARTTHRESHOLDMS, /*HI_U32*/
...
typedef struct hiSYNC_S
{
    ...
    HI_U32                     bUseStopRegion;       /*use stop region or not*/
    HI_U32                     AudStartThresholdMs;  /* Track start threshold (ms), default value is 50ms, max value is equal to u32BufLevelMs */
    HI_S32                     s32StopNegativeTime;
    HI_S32                     s32StopPlusTime;
#ifndef __KERNEL__
...
typedef struct hiSYNC_INFO_S
{
    ...
    struct file    *pFile;           /* SYNC process handle */
