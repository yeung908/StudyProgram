...
/** DTSM6 HA_DOLBYPLUS_EVENT_SOURCE_CHANGE event, stream information user data defination
    ...
    u32DecInfo:
        DTSDECINFO_NONE                     = 0x00000000,
        DTSDECINFO_EMBED_STEREO_DMIX        = 0x00000001,
        DTSDECINFO_EMBED_6CH_DMIX           = 0x00000002,
        DTSDECINFO_EMBED_STEREO_DMIX_COEFF  = 0x00000004,
        DTSDECINFO_EMBED_6CH_DMIX_COEFF     = 0x00000008,
        DTSDECINFO_SPDIF_CORE_OUT           = 0x00000010,
        DTSDECINFO_LT_RT                    = 0x00000020,(indicate Lt/Rt representation)
        DTSDECINFO_LH_RH                    = 0x00000040,(indicate Lhp/Rhp, headphone representation)
*/
