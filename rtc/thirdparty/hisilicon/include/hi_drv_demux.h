...
/**DEMUX data packet*/
/**CNcomment:DEMUXêy?Y°ü?á11*/
typedef struct hiDRV_DMX_DATA_S
{
    HI_VIRT_ADDR_T   u8DataAddr;                   /**<Data pointer*/ /**< CNcomment:êy?Y???? */
    HI_U32  u32Size;                    /**<Data length*/ /**< CNcomment:êy?Y3¤?è */
    HI_UNF_DMX_DATA_TYPE_E enDataType;  /**<Data packet type*/ /**< CNcomment:êy?Y°üμ?ààDí */
} HI_DRV_DMX_DATA_S;
...
{
    HI_VIRT_ADDR_T  DataAddr;      /**<Data address*/          /**<CNcomment: êy?Yμ??· */
    HI_U32  u32DataPhyAddr; /**<Data physical address*/ /**<CNcomment: êy?Yμ???àíμ??· */
    HI_U32  u32Len;         /**<Data length*/           /**<CNcomment: êy?Y3¤?è */
...
/**CNcomment: ?¨ò?ES??á÷?o3??á11ì? */
typedef struct hiDRV_ES_BUF_S
{
    HI_VIRT_ADDR_T u8BufAddr;    /**<User-state virtual address of the buffer*/ /**<CNcomment: bufferμ?ó??§ì?Déμ??·*/
    HI_U32 u32BufLen;  /**<Buffer length*/ /**<CNcomment: bufferμ?3¤?è*/
    HI_U32 u32PtsMs;   /**<Presentation time stamp (PTS) value corresponding to the start of the stream. The invalid value is 0xFFFFFFFF.*/
                       /**<CNcomment: ??á÷?aê?′|??ó|μ?PTS?μ￡??TD§?a0xffffffff*/
}HI_DRV_ES_BUF_S;
