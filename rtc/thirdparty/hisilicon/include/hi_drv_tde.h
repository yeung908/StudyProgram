...
{
    HI_U32 u32PhyAddr;              /**<Header address of a bitmap or the Y component*//**<CNcomment:??¡§a?¡§o?¨¢|¨¬???¡è?¡§¡ãY?¡è?¡§¡é?|¨¬???¡è */
    ...
    HI_U32 u32Stride;               /**<Stride of a bitmap or the Y component*//**<CNcomment:??¡§a????¡§¡§?¡§¡ãY?¡è?¡§¡é????¡§¡§ */
    HI_U32 pu8ClutPhyAddr;          /**<Address of the color look-up table (CLUT), for color extension or color correction*//**<CNcomment:Clut?¨¤¡§a|¨¬???¡è,¡§???¨¢????¡§|?¡§¡è??1?¡§¡ã??¡§|?D?¨º?y*/

    HI_BOOL bYCbCrClut;             /**<Whether the CLUT is in the YCbCr space.*//**<CNcomment:Clut?¨¤¡§a¡§o??¡è???¡§?¡§2YCbCr???? */

    HI_BOOL bAlphaMax255;           /**<The maximum alpha value of a bitmap is 255 or 128.*//**<CNcomment:??¡§a?alpha?¨¢???¡§??|¨¬?a255?1¡§o?128 */

    HI_BOOL bAlphaExt1555;          /*<Whether to enable the alpha extension of an ARGB1555 bitmap.*//**<CNcomment:¡§o??¡è?¡§o1?¡§11555|¨¬?Alpha¡§¡è??1 */
    HI_U8 u8Alpha0;                 /**<Values of alpha0 and alpha1, used as the ARGB1555 format*//**<CNcomment:Alpha0??¨¦Alpha1?|¨¬?¨º?¡§???¨¢??ARGB1555??¡§o? */
    HI_U8 u8Alpha1;                 /**<Values of alpha0 and alpha1, used as the ARGB1555 format*//**<CNcomment:Alpha0??¨¦Alpha1?|¨¬?¨º?¡§???¨¢??ARGB1555??¡§o? */
    HI_U32 u32CbCrPhyAddr;          /**<Address of the CbCr component, pilot*//**<CNcomment:CbCr?¡è?¡§¡é?|¨¬???¡è,pilot */        
    HI_U32 u32CbCrStride;           /**<Stride of the CbCr component, pilot*//**<CNcomment:CbCr?¡è?¡§¡é????¡§¡§,pilot */
}TDE2_IOC_SURFACE_S;
...
#define TDE_GET_LOGIC_TIME _IOR(TDE_IOC_MAGIC, 25, HI_U32)
//#pragma pack()
#ifdef __cplusplus
#if __cplusplus
}
