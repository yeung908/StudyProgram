...
typedef struct hiSIF_STANDARD_LIST_PARAM_S
{
    HI_UNF_SIF_ID_E                     enSifId;
    HI_UNF_SIF_STANDARD_PRIORITY_LIST_S stPriorityList;
} SIF_STANDARD_LIST_PARAM_S, *SIF_STANDARD_LIST_PARAM_S_PTR;
...
#define CMD_SIF_SET_CARRI_SHIFT _IOW(HI_ID_SIF,  0x0e, SIF_CARRISHIFT_S)
#define CMD_SIF_TRY_STANDARD    _IOWR(HI_ID_SIF,  0x0f, SIF_CARRIER_ATTR_S)
#define CMD_SIF_SET_STANDARD_LIST _IOW(HI_ID_SIF, 0x10, SIF_STANDARD_LIST_PARAM_S)
