...
typedef enum tagSTAT_EVENT
{
    ...
    STAT_EVENT_ASTART,
    STAT_EVENT_VSTART,
    STAT_EVENT_OPENTUNER,
    STAT_EVENT_STOPVI,
    STAT_EVENT_STARTVI,
    STAT_EVENT_CREATEVI,
    STAT_EVENT_DESTROYVI,
    STAT_EVENT_CREATEAV,
    STAT_EVENT_DESTROYAV,
    STAT_EVENT_CONNECTDEC,
    STAT_EVENT_SIGSUPPORT,
    STAT_EVENT_CWSET,
    STAT_EVENT_STREAMIN,
...
#define MAX_EVENT_QUEUE_SIZE (20 + 1)      /* ring queue need one more entry for diff empty and full status */
...
static const HI_LD_Event_ID_E g_scenes_desc[MAX_SCENES_TYPE_NR][MAX_EVENT_TYPE_NR] __attribute__((unused)) = 
{
    ...
    {EVENT_VI_FRM_IN, EVENT_VPSS_FRM_IN, EVENT_VPSS_FRM_OUT, EVENT_VI_FRM_OUT, EVENT_VO_FRM_IN,  EVENT_VO_FRM_OUT, EVENT_LD_BUTT},
    ...
    {EVENT_VI_FRM_IN,EVENT_VI_FRM_OUT, EVENT_VO_FRM_IN, EVENT_VO_FRM_OUT, EVENT_LD_BUTT},
};
