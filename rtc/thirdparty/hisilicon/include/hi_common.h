...
typedef enum hiCHIP_VERSION_E
{
    ...
    HI_CHIP_VERSION_LV500 = 0x501,
    HI_CHIP_VERSION_V500 = 0x500, 
    HI_CHIP_VERSION_V510 = 0x510,
    HI_CHIP_VERSION_V520 = 0x520,
    HI_CHIP_VERSION_V530 = 0x530,
    HI_CHIP_VERSION_V600 = 0x600,
...
{
    HI_U32 u32Min;      /**<The minimum value*//**<CNcomment 取值范围最小值 */
    HI_U32 u32Max;      /**<The maximum value*//**<CNcomment 取值范围最大值 */
} HI_RANGE_S;

typedef struct hiCOLOR_S
{
    HI_U32 u32R;        /**<The value of red color*//**<CNcomment 红色分量*/
    HI_U32 u32G;        /**<The value of green color*//**<CNcomment 绿色分量*/
    HI_U32 u32B;        /**<The value of blue color*//**<CNcomment 蓝色分量*/
} HI_COLOR_S;
...
/**
@brief Obtains the chip support attributes. CNcomment: 获取芯片支持的能力属性 CNend
@attention \n
N/A CNcomment: 无 CNend
@param[in] enChipCap Indicate which chip capability. CNcomment: 输入参数，指明获取何种芯片能力属性CNend
