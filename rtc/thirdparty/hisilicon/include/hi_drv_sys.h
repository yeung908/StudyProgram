...
typedef enum
{
    HI_CHIP_PACKAGE_TYPE_BGA = 0,
    HI_CHIP_PACKAGE_TYPE_QFP,
...
extern HI_S32 HI_DRV_SYS_GetChipPackageType(HI_CHIP_PACKAGE_TYPE_E *penPackageType);

extern HI_S32 HI_DRV_SYS_GetTimeStampMs(HI_U32 *pu32TimeMs);
extern HI_S32 HI_DRV_SYS_GetDdpSupport(HI_U32 *pu32Support);
extern HI_S32 HI_DRV_SYS_GetDdSupport(HI_U32 *pu32Support);
extern HI_S32 HI_DRV_SYS_GetDbxSupport(HI_U32 *pu32Support);
